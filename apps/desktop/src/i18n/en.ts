...
export const en: Translations = {
  ...
  boot: {
    ready: 'PhantomBot is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading PhantomBot settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting PhantomBot…'
    },
    errors: {
      backgroundExited: 'PhantomBot background engine exited.',
      backgroundExitedDuringStartup: 'PhantomBot background engine exited during startup.',
    ...
    failure: {
      title: "PhantomBot couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your PhantomBot backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update backend',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting PhantomBot.',
    ...
    native: {
      ...
      inputBody: 'PhantomBot is waiting for your response.',
      turnDoneTitle: 'PhantomBot finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to PhantomBot defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones PhantomBot writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while PhantomBot is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'PhantomBot asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while PhantomBot was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let PhantomBot follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what PhantomBot is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen PhantomBot, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'PhantomBot checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading PhantomBot configuration...',
    ...
    gateway: {
      ...
      intro:
        'PhantomBot starts its own private local engine by default. Use a remote gateway when you want this app to control a compatible backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      restartingMessage: 'PhantomBot will reconnect using the saved settings — the shell stays open.',
      ...
      sshErrPlatform:
        'Unsupported remote platform. PhantomBot SSH mode supports Linux, macOS, and Windows remote hosts.',
  ...
  starmap: {
    ...
    emptyDesc: 'As PhantomBot builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart PhantomBot to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update PhantomBot to generate pets.',
      backgroundHint: 'You can close this — PhantomBot will notify you when it’s done.',
    ...
    runtimeInspector: {
      ...
      kernelBinary: 'Kernel binary',
      desktop: 'Desktop',
      runtime: 'Runtime',
      profile: 'Profile',
      hermesHome: 'Hermes home',
      userData: 'Product data',
      managed: 'managed',
      external: 'external',
      detached: 'detached',
      dirty: 'dirty',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. PhantomBot will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting PhantomBot...',
    placeholderReconnecting: 'Reconnecting to PhantomBot…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give PhantomBot a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'PhantomBot will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask PhantomBot to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating PhantomBot…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting PhantomBot…',
    ...
    unsupportedMessage: 'This version of PhantomBot can’t update itself from inside the app.',
    ...
    availableBodyBackend: 'A newer version of the connected backend is ready to install.',
    ...
    manualBody:
      'This local engine was installed from the command line, so backend updates run there too. Paste this into your terminal:',
    manualPickedUp: 'PhantomBot will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall PhantomBot (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'PhantomBot Setup takes over in its own window and reopens PhantomBot automatically when it’s done. Please don’t reopen PhantomBot yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. PhantomBot reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then PhantomBot reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'PhantomBot needs a one-time setup',
    ...
    setupChoiceTitle: 'Set up PhantomBot',
    setupChoiceDesc:
      'Connect PhantomBot to a compatible gateway you already run, or install its private local engine on this computer.',
    connectExistingTitle: 'Connect an existing backend',
    ...
    installLocalTitle: 'Install the local engine',
    installLocalDesc: 'Prepare PhantomBot’s private runtime and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart PhantomBot and try again.',
    remoteSetupTitle: 'Connect an existing backend',
    remoteSetupDesc: 'Enter your gateway URL. PhantomBot will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the compatible gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up PhantomBot',
  ...
  onboarding: {
    headerTitle: "Let's get PhantomBot set up",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'PhantomBot is finishing setup. This usually takes under a minute on first run.',
    starting: 'Starting PhantomBot…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to power PhantomBot',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `PhantomBot v${version}`,
  ...
  preview: {
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'PhantomBot is restarting...',
      askRestart: 'Ask PhantomBot to restart the server',
      lookingRestart: taskId => `PhantomBot is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'PhantomBot is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message =>
        `PhantomBot finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'PhantomBot could not restart the server.',
      stillWorking:
        'PhantomBot is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'PhantomBot is loading a response',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart PhantomBot to use Save Image.',
    restartToSaveImages: 'Restart PhantomBot to save images',
