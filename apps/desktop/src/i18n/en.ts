...
export const en: Translations = {
  ...
  updates: {
    ...
    applyingBody:
      'The PhantomBot updater takes over in its own window and reopens PhantomBot automatically when it’s done. Please don’t reopen PhantomBot yourself while it’s updating.',
    applyingBodyBackend:
    ...
    blockerTitle: 'Close local previews to update PhantomBot?',
    blockerBody:
      'PhantomBot needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update PhantomBot',
    foreignBlockerBody:
      'PhantomBot can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
  ...
  install: {
    ...
    setupChoiceDesc:
      'Connect this app to a PhantomBot engine you already run, or install the engine locally on this computer.',
    connectExistingTitle: 'Connect to an existing PhantomBot engine',
    ...
    installLocalTitle: 'Install the PhantomBot engine locally',
    installLocalDesc: 'Download the PhantomBot engine and run its private backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart PhantomBot and try again.',
    remoteSetupTitle: 'Connect to an existing PhantomBot engine',
