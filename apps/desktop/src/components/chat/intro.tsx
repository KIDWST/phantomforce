...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should PhantomBot look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} PhantomBot need to see?`,
    ...
    {
      headline: `What should ${label} PhantomBot tackle?`,
