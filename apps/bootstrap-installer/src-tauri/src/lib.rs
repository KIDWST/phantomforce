//! PhantomBot Setup — Tauri entrypoint.
//!
...
pub fn run() {
    ...
    tracing::info!(?mode, force_setup, "PhantomBot installer starting");
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            // PhantomBot Setup doubles as a normal launcher (first run installs, every
            ...
            // Menu/Desktop PhantomBot shortcuts that install.ps1 creates, and a
        ...
        .expect("error while running PhantomBot Setup");
}
