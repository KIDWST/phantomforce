...
import { handleCommand, commandSuggestions } from "./command.js?v=phantom-live-20260713-qa-sweep-01";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260713-qa-sweep-01";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260713-qa-sweep-01";
import { renderMediaStudio, renderMediaSettings } from "./medialab.js?v=phantom-live-20260713-qa-sweep-01";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260713-qa-sweep-01";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260713-qa-sweep-01";
import { renderFlowMap } from "./flowmap.js?v=phantom-live-20260713-qa-sweep-01";
import { mountAgentTicker } from "./agentops.js?v=phantom-live-20260713-qa-sweep-01";
import { renderBrandMemory, renderAutomation } from "./brandops.js?v=phantom-live-20260713-qa-sweep-01";
import { mountCompanion, setCompanionState, getChatSettings } from "./companion.js?v=phantom-live-20260713-qa-sweep-01";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260713-qa-sweep-01";
...
function updateOperationsMapControls() {
  ...
  $$("[data-map-open-label]").forEach((label) => { label.textContent = "Open map"; });
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260713-qa-sweep-01";
let phantom3d = null;
