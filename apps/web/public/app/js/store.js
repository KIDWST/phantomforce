...
export const POSTING_CONNECTORS = [
  {
    ...
    fastConnect: "likely",
    manualUrl: "https://accounts.google.com/",
    manualHint: "Use normal Google sign-in. Then return here and mark Gmail connected.",
  ...
  },
  {
    ...
    fastConnect: "likely",
    manualUrl: "https://accounts.google.com/",
    manualHint: "Use normal Google sign-in. Then return here and mark Calendar connected.",
  ...
  },
  {
    ...
    fastConnect: "likely",
    manualUrl: "https://accounts.google.com/",
    manualHint: "Use normal Google sign-in. Then return here and mark Drive connected.",
  ...
  },
  {
    ...
    clientState: "locked",
    connectionState: "not-connected",
    fastConnect: "manual-likely",
    manualUrl: "https://www.youtube.com/",
    manualHint: "Sign in to the channel owner account. YouTube posting stays approval-gated.",
  ...
  },
  {
    ...
    connectionState: "not-connected",
    fastConnect: "manual-likely",
    manualUrl: "https://business.facebook.com/",
    manualHint: "Sign in through Meta Business. Instagram permissions are managed there.",
  ...
  },
  {
    ...
    fastConnect: "manual-likely",
    manualUrl: "https://business.facebook.com/",
    manualHint: "Sign in through Meta Business and choose the correct Facebook page.",
  ...
  },
  {
    ...
    connectionState: "not-connected",
    fastConnect: "manual-likely",
    manualUrl: "https://www.tiktok.com/login",
    manualHint: "Sign in to the right TikTok account. Publishing stays approval-gated.",
...
function normalizeData(data) {
  ...
  d.postingConnectors = POSTING_CONNECTORS.map((connector) => {
    ...
    return {
      ...
      connectionState: saved?.connectionState || connector.connectionState,
      connectionMethod: saved?.connectionMethod || connector.connectionMethod,
      lastConnectAttempt: saved?.lastConnectAttempt || connector.lastConnectAttempt,
      lastConnectMessage: saved?.lastConnectMessage || connector.lastConnectMessage,
    };
  });
...
export const STATUS_LABEL = {
  ...
  "not-connected": "Not signed in", "connected": "Connected", "manual-needed": "Manual sign-in", "manual-started": "Manual started",
};
