...
export const TOOL_SPINE = [
  ...
  },
  {
    ...
    mode: "planning",
    status: "planned",
    role: "Sketches bounded agent loops, handoffs, and review gates across Phantom workers.",
    ownerControl: "Loopus is planning-only until a real loop runner is connected. It can propose loops, not execute them.",
    activity: "Loopus is sketching safe loop plans for future coordinated agent runs.",
    path: "Loopus planner",
    visibleToClients: false,
  },
  {
