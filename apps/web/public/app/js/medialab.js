...
import { PLATFORMS, registerContentAsset } from "./contenthub.js?v=phantom-live-20260713-qa-sweep-01";
...
function applyHermesProfilePacket(payload = {}) {
  ...
  socialNotice = `${account.name} auto-connected from the visible browser profile. Stored only public handle/profile fields; no cookies, passwords, tokens, or private messages were read.`;
  rerenderMediaSettings();
}
