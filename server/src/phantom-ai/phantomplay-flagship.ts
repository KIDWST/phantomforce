...
export const PHANTOMPLAY_FLAGSHIP_GAMES: PhantomPlayGame[] = [
  {
    ...
    developer: "Tak",
    kind: "built_in",
    launchUrl: "/app/games/cubetown/index.html?v=1.2.0",
  ...
  },
  {
    ...
    developer: "Tak",
    kind: "built_in",
    launchUrl: "/app/games/skyguard-arena/index.html?v=1.2.0",
  ...
  },
  {
    id: "crown-circuit",
    title: "Crown Circuit",
    summary: "Solo bot training plus 1v1 lane-card crown duels with elixir, towers, card picks, and PhantomPlay room support.",
    description: "A royale-style lane battler: start Solo Training against Crown Bot to learn lane pressure and elixir timing, then play the same drag-and-drop troop duel in a private PhantomPlay room with two signed-in players.",
    category: "Strategy",
    ...
    developer: "Tak",
    kind: "built_in",
    launchUrl: "/app/games/crown-circuit.html?v=1.2.0",
  ...
  },
  {
    ...
    description: "A network-silent first-person shooter with real vertical aim (shots respect where you point, including over cover), sprint, jump, crouch, aim-down-sights, ammo and reloads, low sandbag cover that protects crouching fighters, three 24x24 military maps with buildings and containers, a rotating minimap, compass, killfeed, Solo Ops against a labeled four-bot squad, and genuine same-device 1v1 split-screen.",
    category: "Arcade",
    ...
    developer: "Tak",
    kind: "built_in",
    launchUrl: "/app/games/phantom-strike.html?v=2.0.0",
