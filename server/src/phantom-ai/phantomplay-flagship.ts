...
export const PHANTOMPLAY_FLAGSHIP_GAMES: PhantomPlayGame[] = [
  ...
  },
  {
    ...
    summary: "Defend animated routes with 3-tier Sentinels, Century Watch bosses, Neon Tangle, relay surges, and Overcharge.",
    ...
    developer: "Tak",
    kind: "built_in",
    launchUrl: "/app/games/skyguard-arena/index.html?v=1.3.0",
