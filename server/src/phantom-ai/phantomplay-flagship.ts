...
export const PHANTOMPLAY_FLAGSHIP_GAMES: PhantomPlayGame[] = [
  ...
  },
  {
    ...
    description: "A network-silent first-person ray-cast shooter with Solo Ops against a labeled bot squad, genuine same-device 1v1 split-screen, three maps, configurable weapons, hit feedback, respawns, and an after-action report.",
    category: "Arcade",
