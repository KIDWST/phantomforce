...
export const PHANTOMPLAY_FLAGSHIP_GAMES: PhantomPlayGame[] = [
  ...
  },
  {
    ...
    description: "A physics-based siege/destruction game: drag to aim and fire one of three ammunition types — hard-hitting Stonefall Orbs, piercing Splinter Lances, or splash-damage Emberburst Charges — at a rigid-body-simulated fortress built from stone, timber, and ironclad blocks. Clear a 6-hold Siege Campaign ending at the ironclad-cored Warlord's Anvil boss, fight a Duel vs a bot rival with two castles and two siege engines where the goal is to drop the enemy Warden, or join a Siege Party room where everyone breaches their own copy of the same fortress against a shared clock. Stars come from breach percentage, ammo conserved, and keeping every Warden un-harmed; knocking out a hold's glowing keystone block triggers a slow-motion final blow.",
    category: "Strategy",
    ...
    developer: "PhantomPlay Studio",
    kind: "built_in",
    launchUrl: "/app/games/kingdom-breakers.html?v=1.0.2",
