...
export const PHANTOMPLAY_FLAGSHIP_GAMES: PhantomPlayGame[] = [
  {
    id: "cubetown",
    title: "Shadowbearer: Dawn's Return",
    summary: "A storybook action-adventure where projected light turns shadow into real paths, bridges, cover, and weapons.",
    description: "Begin in the living village of Bramblewick, carry Sera's Dawnlantern component along the old road, and survive the Pale Warden's arrival. When Shadowfall rewrites the same world, return through corrupted streets by making cast shadows solid, restore the first Dawnlamp, and uncover why the world remembers morning incorrectly.",
    category: "Adventure",
    tags: ["unreal", "native", "storybook", "action-adventure", "memorycraft", "shadow", "exploration"],
    ...
    thumbnail: "/app/assets/phantomplay/shadowbearer-cover.png?v=1.0.0",
    featured: true,
    version: "1.0.1-dawns-return",
    controls: "Native Unreal player. WASD moves, mouse controls the full orbit camera, Shift sprints, Space jumps or climbs, LMB attacks, RMB guards, E interacts, and Q opens Memorycraft.",
