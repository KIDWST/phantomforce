...
export const PHANTOMPLAY_FLAGSHIP_GAMES: PhantomPlayGame[] = [
  {
    id: "cubetown",
    title: "Shadowbearer: Dawn's Light",
    summary: "A storybook action-adventure where projected light turns shadow into real paths, bridges, cover, and weapons.",
    description: "Begin in the living village of Bramblewick, carry Sera's Dawnlantern component along the old road, and survive the Pale Warden's arrival. When Shadowfall rewrites the same world, return through corrupted streets by making cast shadows solid, restore the first Dawnlamp, and uncover why the world remembers morning incorrectly. PhantomPlay's local Unreal buildset floor is V28R6, so this catalog entry must not fall back to older Dawn's Return copy.",
    category: "Adventure",
    ...
    featured: true,
    version: "1.2.0-dawns-light · V28R6",
  ...
  },
  {
    ...
    featured: true,
    version: "1.4.0-blackridge · V38R10",
