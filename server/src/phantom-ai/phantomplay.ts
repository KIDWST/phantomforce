...
export const PHANTOMPLAY_BUILT_IN_GAMES: PhantomPlayGame[] = [
  ...
  },
  {
    id: "phantom-ages",
    title: "Phantom Ages",
    summary: "Age-of-War-style tug-of-lane battle: five eras, a branching Military/Tech path, and an AI opponent.",
    description: "Advance your civilization through five eras while pushing an AI opponent's base down the lane — spend resources on units and structures, choose a Military or Tech branch as you evolve, and out-produce the enemy before they overrun your base.",
    category: "Strategy",
    ...
    featured: false,
    version: "1.0.0",
    controls: "Click units and structures in the build bar to spend resources. Pick your era branch when prompted.",
    progressSupport: true,
    scoreSupport: true,
