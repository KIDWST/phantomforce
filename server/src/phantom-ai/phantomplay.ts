...
export const PHANTOMPLAY_BUILT_IN_GAMES: PhantomPlayGame[] = [
  ...
  {
    id: "vespergate",
    title: "Vespergate 3.1: Living Dread",
    summary: "A painterly portal adventure with a living Presence, six quests, two dungeons, world discovery, and Vesper mastery.",
    description: "The definitive top-down action-adventure across Duskhollow, Vesper Vale, the Hollow Geometry, and the Glass Ossuary. Version 3.1 restores the illustrated bearer with a pointed hood, narrow mask, asymmetric mantle, split cloak tails, and readable animation; profession-specific villagers; denser environmental life; richer rooms; persistent checkpoints; encounter objectives; bell sequences; mirror relays; and sanctum progression. It also retains the complete 3.0 feature set: touch and gamepad controls, the wayfinder map, room discovery, portal and foldshot mastery, Vesper Sense, automatic saves, 2.x migration, and portable PhantomPlay save-state handoff.",
    category: "Arcade",
    tags: ["action-adventure", "portal", "gothic", "zelda-like", "top-down", "open-world", "gamepad", "touch"],
    contentRating: "teen",
    contentDescriptors: ["fantasy_conflict", "intense_action"],
    developer: "Tak",
    developerAvatar: TAK_AVATAR,
    kind: "built_in",
    launchUrl: "/app/games/vespergate/index.html?v=3.1.0",
    thumbnail: GAME_ART_BY_SLUG["vespergate"],
    featured: true,
    version: "3.1.0",
    controls: "WASD moves; left-click strikes; F fires the full-health beam; G places gates; right-click places a gate until Vespershield unlocks, then activates the shield; Q swaps; R vents; Shift rolls; E interacts; Space uses Vesper Sense; M opens the map; Tab opens inventory; Alt+Enter toggles fullscreen. Touch and gamepad controls are built in.",
    progressSupport: true,
    scoreSupport: true,
