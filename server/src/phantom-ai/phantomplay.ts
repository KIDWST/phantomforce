...
export const PHANTOMPLAY_BUILT_IN_GAMES: PhantomPlayGame[] = [
  ...
  },
  {
    ...
    developerAvatar: TAK_AVATAR,
    kind: "built_in",
    launchUrl: "/app/games/vespergate/index.html?v=3.0.0",
    thumbnail: GAME_ART_BY_SLUG["vespergate"],
    featured: true,
    version: "3.0.0",
    controls: "WASD moves; left-click strikes; F fires the full-health beam; right-click places gates; Q swaps; R vents; Shift rolls; E interacts; Space uses Vesper Sense; M opens the map; Tab opens inventory; Alt+Enter toggles fullscreen. Touch and gamepad controls are built in.",
    progressSupport: true,
    scoreSupport: true,
