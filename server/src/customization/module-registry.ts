...
export const PLATFORM_MODULES: PlatformModuleDefinition[] = [
  ...
  { id: "crm", displayName: "Leads", description: "Prospects, qualification, pipeline, and follow-up. Actual clients live in client workspaces after they are won.", icon: "users", route: "leads", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager", "member"], mobile: true },
