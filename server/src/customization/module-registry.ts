...
export const PLATFORM_MODULES: PlatformModuleDefinition[] = [
  ...
  { id: "clientsetup", displayName: "Client Setup", description: "Configure client organizations, modules, offers, leads, approvals, and reports.", icon: "users", route: "clientsetup", required: false, customerConfigurable: true, dependencies: ["crm", "approvals"], allowedRoles: ["owner", "admin", "manager"], mobile: true },
  ...
  { id: "planner", displayName: "Planner", description: "Roadmaps, plans, and focused developer/business work blocks.", icon: "check", route: "planner", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager", "member"], mobile: true },
  { id: "phantomplay", displayName: "PhantomPlay", description: "Intentional breaks, games, and approved community releases.", icon: "media", route: "phantomplay", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager", "member", "client"], mobile: true },
  { id: "phantomstore", displayName: "PhantomStore", description: "AI marketplace for reviewed tools, agents, templates, models, and operator apps.", icon: "spark", route: "phantomstore", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager", "member", "client"], mobile: true },
  { id: "intelligence", displayName: "Competitor Intelligence", description: "Lawful public-signal analysis, audience gaps, and original response planning.", icon: "chart", route: "intelligence", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager"], mobile: true },
