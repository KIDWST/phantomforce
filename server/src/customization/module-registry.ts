...
export const PLATFORM_MODULES: PlatformModuleDefinition[] = [
  ...
  { id: "money", displayName: "Accounting", description: "Revenue, expenses, offers, and financial visibility.", icon: "dollar", route: "money", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager", "developer"], mobile: true },
  { id: "planner", displayName: "Planner", description: "Roadmaps, plans, and focused developer/business work blocks.", icon: "check", route: "planner", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager", "member", "developer"], mobile: true },
  { id: "phantomplay", displayName: "PhantomPlay", description: "Intentional breaks, games, and approved community releases.", icon: "media", route: "phantomplay", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager", "member", "client", "developer"], mobile: true },
