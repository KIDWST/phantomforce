...
export const PLATFORM_MODULES: PlatformModuleDefinition[] = [
  ...
  { id: "phantomstore", displayName: "PhantomStore", description: "AI marketplace for reviewed tools, agents, templates, models, and operator apps.", icon: "spark", route: "phantomstore", required: true, customerConfigurable: false, dependencies: [], allowedRoles: ["owner", "admin", "manager", "member", "client"], mobile: true },
