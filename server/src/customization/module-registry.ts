...
export const PLATFORM_MODULES: PlatformModuleDefinition[] = [
  ...
  { id: "memory", displayName: "Context Learning", description: "Backend business context, Hermes recall, and private process memory.", icon: "brain", route: "settings", required: false, customerConfigurable: false, dependencies: ["settings"], allowedRoles: ["owner", "admin", "manager"], mobile: false },
