...
export const PLATFORM_MODULES: PlatformModuleDefinition[] = [
  ...
  { id: "media", displayName: "Media Lab", description: "Image and video creation and editing.", icon: "media", route: "media", required: false, customerConfigurable: true, dependencies: ["content"], allowedRoles: ["owner", "admin", "manager", "member"], mobile: true },
  ...
  { id: "content", displayName: "Creator Hub", description: "Content library, performance, and publishing readiness.", icon: "doc", route: "content", required: false, customerConfigurable: true, dependencies: [], allowedRoles: ["owner", "admin", "manager", "member"], mobile: true },
