...
function seed() {
  ...
  const agents = [
    { id: "ag-router", name: "Command Router", role: "Reads every request and routes it to the right desk.", status: "active", mission: "Standing by for your next command.", d1: 14, d7: 96, d30: 388, tokens: "212k", cost: "$1.84", last: "Routed 'draft proposal for Chen & Park' to Proposal Forge.", next: "—", bundle: "AgentOS router · model lane A" },
    { id: "ag-leads", name: "Lead Hunter", role: "Watches every channel for new business and qualifies it.", status: "active", mission: "Qualifying Ade Events (event volume, booking flow).", d1: 6, d7: 41, d30: 163, tokens: "301k", cost: "$2.61", last: "Found 2 follow-up opportunities in the missed-lead pile.", next: "Qualify Folake Adeyemi by tomorrow.", bundle: "AgentOS + intake specs" },
