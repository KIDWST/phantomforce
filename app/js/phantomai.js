...
import { isOwnerOperator } from "./store.js?v=phantom-live-20260717-6";
import { mountAgentConsole } from "./agentops.js?v=phantom-live-20260717-6";
...
function mountMemoryTab() {
  ...
  import("./brain.js?v=phantom-live-20260717-6")
