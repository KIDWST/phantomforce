...
import { isOwnerOperator } from "./store.js?v=phantom-live-20260715-1";
import { mountAgentConsole } from "./agentops.js?v=phantom-live-20260715-1";
...
function mountMemoryTab() {
  ...
  import("./brain.js?v=phantom-live-20260715-1")
