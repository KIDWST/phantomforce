...
import { isOwnerOperator } from "./store.js?v=phantom-live-20260716-2";
import { mountAgentConsole } from "./agentops.js?v=phantom-live-20260716-2";
...
function mountMemoryTab() {
  ...
  import("./brain.js?v=phantom-live-20260716-2")
