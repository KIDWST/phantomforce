...
import { mountAgentConsole } from "./agentops.js?v=phantom-live-20260817-160";
import { renderAutomation } from "./brandops.js?v=phantom-live-20260817-160";
import { handleCommand, handleSmartCommand, handleInvoiceRequest } from "./command.js?v=phantom-live-20260817-160";
import { esc } from "./workspaces.js?v=phantom-live-20260817-160";
import { analyzeFile, humanSize } from "./docanalyzer.js?v=phantom-live-20260817-160";
import { openInvoicePrintable } from "./invoices.js?v=phantom-live-20260817-160";
...
import {
  ...
  MAX_PROMPT_CHARS,
  promptSizeError,
} from "./prompt-integrity.js?v=phantom-live-20260817-160";
