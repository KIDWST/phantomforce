...
export function normalizeCompanionPrefs(value) {
  ...
  return {
    ...
    roamingEnabled: bool(input.roamingEnabled, DEFAULT_COMPANION_PREFS.roamingEnabled),
    ...
    dockLocation: choice(input.dockLocation, ["bottom-right", "bottom-left", "sidebar"], DEFAULT_COMPANION_PREFS.dockLocation),
