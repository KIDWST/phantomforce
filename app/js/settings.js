...
import { renderMediaSettings } from "./medialab.js?v=phantom-live-20260716-316";
import { renderCustomizationStudio } from "./customization.js?v=phantom-live-20260716-316";
import { renderOrganizationPanel } from "./organization.js?v=phantom-live-20260716-316";
import { fetchCustomerPlanPreview, fetchEntitlementsSummary, switchCustomerPlan } from "./orgs.js?v=phantom-live-20260716-316";
import { currentTenantId, ctx, loadPhantomLoop, savePhantomLoop, LOOP_PROVIDERS, modelDisplayLabel, session, workspaceStorageGetItem, workspaceStorageSetItem } from "./store.js?v=phantom-live-20260716-316";
import { DEFAULT_COMPANION_PREFS, clearCompanionSessionHide, loadCompanionPrefs, resetCompanionPrefs, saveCompanionPrefs } from "./companion-preferences.js?v=phantom-live-20260716-316";
...
const SETTINGS_CONTEXT = {
  ...
  plan: { title: "Plan & access", description: "Test customer tiers, feature gates, usage limits, and upgrade restrictions from one safe settings panel." },
