...
import { classifyPhantomIntent as classifyRaw, deriveActionContract } from "./intent-router.js?v=phantom-live-20260722-29";
import { baseSiteDraft, ensureSiteDesign, applyWebsitePrompt } from "./workspaces.js?v=phantom-live-20260722-29";
...
async function generateMediaFromChat(text, intent, settings) {
  try {
    const mediaLab = await import("./medialab.js?v=phantom-live-20260722-29");
