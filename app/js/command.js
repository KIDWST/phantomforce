...
import { classifyPhantomIntent as classifyRaw, deriveActionContract } from "./intent-router.js?v=phantom-live-20260723-47";
import { baseSiteDraft, ensureSiteDesign, applyWebsitePrompt } from "./workspaces.js?v=phantom-live-20260723-47";
...
async function generateMediaFromChat(text, intent, settings) {
  try {
    const mediaLab = await import("./medialab.js?v=phantom-live-20260723-47");
