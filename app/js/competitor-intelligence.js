import { currentTenantId, session } from "./store.js?v=phantom-live-20260714-003";

const esc = (value) => String(value ?? "").replace(/[&<>"']/g, (char) => ({ "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }[char]));
const TABS = [
  ["discover", "Discover"], ["overview", "Market radar"], ["signals", "Sources"], ["opportunities", "Opportunities"],
