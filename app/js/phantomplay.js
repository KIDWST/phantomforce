...
const BUILT_INS = [
  ...
  { id: "cubetown", title: "CubeTown", summary: "Unreal Engine 5.8 native voxel adventure: mine, build, learn echoes, restore shrines, and fight the Rift Guardian.", description: "The Unreal-native Cubetown player is the current canonical build: a voxel island adventure inspired by Echoes of Wisdom and Minecraft, with mining, block placement, learned Echo companions, Wisdom Shrines, combat, waves, and a guardian finale. PhantomPlay still preserves web and other engine compatibility for unrelated uploads.", category: "Creative", tags: ["unreal", "native", "building", "voxel", "adventure", "echoes", "touch"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/native/cubetown?engine=unreal&version=5.8", thumbnail: GAME_ART_BY_SLUG["cubetown"], featured: true, version: "5.8.0-unreal", controls: "Native Unreal player. WASD moves, left mouse mines or attacks, right mouse places blocks, Q cycles blocks, R cycles Echoes, E summons, F restores shrines, Space dashes with an Echo burst.", progressSupport: true, scoreSupport: true, engine: { tier: "Unreal Engine 5.8", minVersion: PHANTOMPLAY_ENGINE.version } },
