...
} from "./store.js?v=phantom-live-20260719-53";
...
const BUILT_INS = [
  ...
  { id: "crown-circuit", title: "Crown Circuit", summary: "1v1 lane-card crown duel with animated cartoony troops, elixir, towers, and drag-and-drop deploy.", description: "The royale-style lane battler that was missing from the library: two players spend elixir and drag animated troops onto their side of the field to break the enemy crown tower. No fake solo bot mode; it is a private PhantomPlay room with two signed-in players, one device each.", category: "Strategy", tags: ["card", "lane", "royale", "multiplayer", "pvp", "drag-and-drop", "touch"], contentRating: "everyone10", contentDescriptors: ["strategic_complexity", "competitive_play"], multiplayerDescriptor: "Two-player private PhantomPlay room duel, one device each — laptop, Chromebook, or phone. No public matchmaking, chat, or voice.", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/crown-circuit.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["crown-circuit"], featured: true, version: "1.1.0", controls: "Drag a card from your hand onto your side of the field to deploy that troop. Touch or mouse.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "keyboardist-on-tour", title: "Cipher Keep", summary: "A typing roguelike dungeon crawl — type your way through rooms, foes, and vaults.", description: "Type words to move through a shifting procedural dungeon, strike down foes in real-time typing duels, crack sealed vaults before their fuse burns out, and choose relics to empower your run. Typing speed lands harder hits while mistake-free accuracy builds a Combo multiplier and fills Ink for Focus Surges. Permadeath means every descent counts, and every run reshuffles the Keep from a fresh seed.", category: "Focus", tags: ["typing", "roguelike", "dungeon", "keyboard", "permadeath", "procedural"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/keyboardist-on-tour.html?v=2.0.0", thumbnail: GAME_ART_BY_SLUG["keyboardist-on-tour"], featured: true, version: "2.0.0", controls: "Just type — full keyboard input, no fixed lane keys. Backspace corrects mistakes. P or Esc pauses. On-screen keyboard shown for touch.", progressSupport: true, scoreSupport: true },
