...
const BUILT_INS = [
  ...
  { id: "focus-stack", title: "Focus Stack", summary: "Drop perfect layers, build flow, and stack the tallest signal tower.", description: "A focused timing run with a visible score, proper start, pause, restart, and resize-safe play field.", category: "Focus", tags: ["timing", "focus", "quick"], contentRating: "toddler", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/focus-stack.html?v=1.2.0", thumbnail: GAME_ART_BY_SLUG["focus-stack"], featured: false, version: "1.2.0", controls: "Space, Enter, click, or tap", progressSupport: true, scoreSupport: true },
  { id: "word-weld", title: "Word Weld", summary: "Weld words from shifting racks with combo sparks and time bonuses.", description: "A quicker, juicier word-building game with keyboard/touch input, combo scoring, forged-word bursts, timer bonuses, and clean reset controls.", category: "Creative", tags: ["word", "creative", "quick", "touch"], contentRating: "toddler", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/word-weld.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["word-weld"], featured: true, version: "1.1.0", controls: "Keyboard, tap letters, Enter to submit", progressSupport: true, scoreSupport: true },
  ...
  { id: "penalty-kick", title: "Penalty Kick", summary: "Pick your lane, time the strike, and beat the keeper.", description: "A touch-friendly sports timing game with five shots, visible score, keeper reads, and saved score.", category: "Sports", tags: ["sports", "timing", "soccer", "touch"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/penalty-kick.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["penalty-kick"], featured: false, version: "1.1.0", controls: "Choose one of five lanes, read the keeper, then shoot in the sweet spot.", progressSupport: true, scoreSupport: true },
...
function renderToddlerSpace() {
  ...
  return `<div class="pp-toddler-space">
    <section class="pp-toddler-hero">
      ...
      <p>A simplified kids-only area: only the approved Kids games live here, no chat, no voice, no multiplayer rooms, and no links off this screen.</p>
    </section>
...
function render() {
  ...
  const tabs = [["home", "Sandbox"], ["library", "Play Lab"], ["together", "Multiplayer"], ["favorites", "Saved"], ["toddler", "Kids Only"], ["developer", "Dev Rooms"], ["submit", "Submit Game"], ...(snapshot.access.canModerate ? [["admin", "Safety Review"]] : [])];
