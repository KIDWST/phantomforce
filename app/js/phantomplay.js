...
} from "./store.js?v=phantom-live-20260720-3";
...
const BUILT_INS = [
  ...
  { id: "crown-circuit", title: "Crown Circuit", summary: "Strict 1v1 lane-card crown duel with elixir, towers, card picks, and PhantomPlay room support.", description: "The royale-style lane battler that was missing from the library: two players pick cards, spend elixir, deploy onto three lanes, and break the crown tower. No fake solo bot mode; it is local two-player or a private PhantomPlay room with two signed-in players.", category: "Strategy", tags: ["card", "lane", "royale", "multiplayer", "pvp"], contentRating: "everyone10", contentDescriptors: ["strategic_complexity", "competitive_play"], multiplayerDescriptor: "Local same-keyboard duel or two-player private room duel. No public matchmaking, chat, or voice.", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/crown-circuit.html?v=1.0.0", thumbnail: GAME_ART_BY_SLUG["crown-circuit"], featured: true, version: "1.0.0", controls: "Two-player only. Blue uses 1-4 and Q/W/E. Red uses 7-0 and I/O/P.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "skyguard-arena", title: "Skyguard Arena", summary: "BTD-style sentinel defense with Glint, route pressure, tower upgrades, waves, and duel modes.", description: "A larger tower-defense battle with Sentinels, Glint economy, Overcharge, boss waves, skirmish pressure, and private room duels. It is back in the fallback catalog so the deeper strategy games stay findable.", category: "Strategy", tags: ["tower-defense", "strategy", "pvp", "waves"], contentRating: "everyone10", contentDescriptors: ["cartoon_action", "strategic_complexity", "competitive_play"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/skyguard-arena/index.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["skyguard-arena"], featured: true, version: "1.1.0", controls: "Choose Sentinel cards, place on lane slots, upgrade, and trigger Overcharge with Q.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "phantom-grand-prix", title: "Phantom Grand Prix", summary: "Kart racer with drift-charged mini-turbos, catch-up item odds, and local split-screen multiplayer.", description: "A top-down kart racer with three-tier drift mini-turbos, five rank-weighted items, kart bumping, a minimap, and live positions. 1-player vs 3 CPU racers, or 2-player local split-screen with 2 CPU racers filling the grid.", category: "Arcade", tags: ["racing", "kart", "multiplayer", "local-coop", "touch"], contentRating: "everyone", multiplayerDescriptor: "Local 2-player split-screen on one keyboard. No networking.", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-grand-prix/index.html?v=1.0.0", thumbnail: CATEGORY_ART["Arcade"], featured: false, version: "1.0.0", controls: "P1: WASD, Shift drift, Space item. P2: arrows, / drift, Enter item.", progressSupport: true, scoreSupport: true },
  { id: "phantom-cube", title: "PhantomCube", summary: "Isometric tile-clearing puzzle — slide the cube, tiles crumble behind you, clear the board to win.", description: "Slide an isometric cube across boards where tiles crumble the moment you leave them; clear every tile, then reach the exit. 12 original solver-verified levels with double tiles, teleporter pairs, level select, par, and best-score stars.", category: "Puzzle", tags: ["puzzle", "levels", "logic", "touch"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-cube/index.html?v=1.0.0", thumbnail: CATEGORY_ART["Puzzle"], featured: false, version: "1.0.0", controls: "Arrow keys or WASD to slide. R restarts, L opens level select.", progressSupport: true, scoreSupport: true },
  { id: "phantom-chess", title: "Phantom Chess", summary: "Complete chess — castling, en passant, promotion — local 2-player or against the Phantom AI.", description: "Full chess rules with castling, en passant, promotions, and check/checkmate/stalemate detection. Local 2-player on one board, or White vs a negamax alpha-beta AI. Legal-move highlights and captured-piece trays.", category: "Strategy", tags: ["chess", "board", "multiplayer", "touch"], contentRating: "everyone", multiplayerDescriptor: "Local pass-and-play on one device. No networking.", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-chess/index.html?v=1.0.0", thumbnail: CATEGORY_ART["Strategy"], featured: false, version: "1.0.0", controls: "Click a piece, then a highlighted destination square.", progressSupport: true, scoreSupport: true },
  { id: "phantom-pizzeria", title: "Phantom Pizzeria", summary: "Read the ticket, build the pie, bake it in the window, serve it hot. Five orders a day.", description: "An order-ticket time-management game: read each ghostly customer's topping order, build the pie, pull it from the oven inside the timing window, and serve before patience runs out. Day-end reports and unlocking toppings.", category: "Focus", tags: ["time-management", "simulation", "touch"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-pizzeria/index.html?v=1.0.0", thumbnail: CATEGORY_ART["Focus"], featured: false, version: "1.0.0", controls: "Click toppings to place them, click through the oven to bake and serve.", progressSupport: true, scoreSupport: true },
  { id: "phantom-strike", title: "Phantom Strike", summary: "First-person arena shooter — hold the Rift Yard against five waves of spectral raiders.", description: "A real-time 3D raycast FPS: hold a walled arena against five escalating waves of drifters, spitters, and wardens with three weapons, pickups, and a live minimap. Keyboard + pointer-lock mouse, full gamepad, and touch controls.", category: "Arcade", tags: ["shooter", "fps", "3d", "waves", "gamepad", "touch"], contentRating: "everyone10", contentDescriptors: ["fantasy_conflict", "intense_action"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-strike/index.html?v=1.0.0", thumbnail: CATEGORY_ART["Arcade"], featured: true, version: "1.0.0", controls: "WASD + mouse (click to lock), 1-3/Q swap. Gamepad: sticks aim/move, RT fires, Y swaps. Touch: stick + drag-aim + fire.", progressSupport: true, scoreSupport: true },
];
