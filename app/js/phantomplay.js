...
const BUILT_INS = [
  { id: "neon-drift", title: "Neon Drift", summary: "Auto-fire spaceship shooter with waves, powerups, and shield saves.", description: "Fly a neon ship, fire nonstop, collect rapid fire, spread shot, shield, magnet, and repair powerups, then survive harder waves with keyboard, mouse, or touch controls.", category: "Arcade", tags: ["shooter", "powerups", "arcade", "touch"], contentRating: "everyone", developer: TAK_CREATOR, kind: "built_in", launchUrl: "/app/games/neon-drift.html?v=1.2.2", thumbnail: "/app/assets/poses/mode-dark-video.webp", featured: true, version: "1.2.2", controls: "WASD/arrow keys to fly. Auto-fire is always on. Touch and drag on mobile.", progressSupport: true, scoreSupport: true },
