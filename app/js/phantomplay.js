...
} from "./store.js?v=phantom-live-20260817-161";
...
const BUILT_INS = [
  ...
  { id: "vespergate", title: "Vespergate: The Vesper Hand", summary: "A painterly top-down portal adventure with doorway checkpoints, kinder combat, hidden caches, and a projectile-reflecting shield.", description: "An original top-down action-adventure set across Duskhollow village, an open vale, the Hollow Geometry, and the Glass Ossuary. Version 2.5.0 makes the journey more playful and readable: deaths return you to the last doorway, Maren's portal-sealed starter cache teaches the Hand and funds the first outing, enemies and the bearer physically knock apart on contact, healing drops keep momentum going, and the full-health beam moves to Space. Defeat Bellmother midway through the tale to earn the cooldown-based Vespershield, reflect hostile shots, and push attackers away. Outdoor travel, dungeon exploration, and boss fights now carry distinct scores.", category: "Arcade", tags: ["action-adventure", "portal", "gothic", "zelda-like", "top-down", "open-world", "gamepad"], contentRating: "teen", contentDescriptors: ["fantasy_conflict", "intense_action"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/vespergate/index.html?v=2.5.0", thumbnail: GAME_ART_BY_SLUG["vespergate"], featured: true, version: "2.5.0", controls: "WASD moves, left-click strikes, Space fires the full-health beam, right-click places gates until the Vespershield unlocks and then raises the shield, G places gates, Q swaps, R vents, Shift rolls, E interacts, Tab opens inventory, and Alt+Enter toggles fullscreen. Full gamepad support.", progressSupport: true, scoreSupport: true },
