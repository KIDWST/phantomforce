...
} from "./store.js?v=phantom-live-20260819-168";
...
const BUILT_INS = [
  ...
  { id: "vespergate", title: "Vespergate 3.0: Living Dread", summary: "A painterly portal adventure with a living Presence, six quests, two dungeons, world discovery, and Vesper mastery.", description: "A complete top-down action-adventure across Duskhollow, Vesper Vale, the Hollow Geometry, and the Glass Ossuary. Version 3.0 adds fully playable touch controls, a persistent wayfinder map, room discovery, portal-crossing and foldshot mastery ranks, the cooldown-based Vesper Sense guidance pulse, automatic campaign saves, migration of existing 2.x progress, and portable PhantomPlay save-state handoff. The original six-quest campaign, linked momentum-preserving gates, Vesper Soul upgrades, relics, cosmetics, Presence dread system, Choir of Glass encounter, and three-phase Bellmother fight remain intact.", category: "Arcade", tags: ["action-adventure", "portal", "gothic", "zelda-like", "top-down", "open-world", "gamepad", "touch"], contentRating: "teen", contentDescriptors: ["fantasy_conflict", "intense_action"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/vespergate/index.html?v=3.0.0", thumbnail: GAME_ART_BY_SLUG["vespergate"], featured: true, version: "3.0.0", controls: "WASD moves; left-click strikes; F fires the full-health beam; right-click places gates; Q swaps; R vents; Shift rolls; E interacts; Space uses Vesper Sense; M opens the map; Tab opens inventory; Alt+Enter toggles fullscreen. Touch and gamepad controls are built in.", progressSupport: true, scoreSupport: true },
