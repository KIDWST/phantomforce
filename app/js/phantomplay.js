...
const BUILT_INS = [
  ...
  { id: "phantom-ages", title: "Phantom Ages", summary: "Age-of-War lane pusher: bank gold, spawn units, advance eras, and break the enemy base.", description: "A real Age-of-War-style lane battle: earn gold from your units, spend it to spawn a growing roster, and fire your base turret at the nearest enemy in range. Advance through Stone, Bronze, Iron, Industrial, and Future eras to unlock stronger fighters, then pick a Military or Tech path at the Industrial threshold that reshapes every era after it. Runs on a fixed-timestep simulation with pooled units and projectiles — smooth even under a full lane. Win by destroying the enemy base before they destroy yours.", category: "Strategy", tags: ["strategy", "lane", "age-of-war", "tower", "eras", "single-player"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-ages/index.html?v=1.0.0", thumbnail: GAME_ART_BY_SLUG["phantom-ages"], featured: true, version: "1.0.0", controls: "Click a unit card to spawn it. Space or the turret button fires your base turret. Advance eras to unlock stronger units.", progressSupport: false, scoreSupport: true },
