...
import { renderVoiceChannels } from "./voicechannels.js?v=phantom-live-20260717-18";
...
const BUILT_INS = [
  ...
  { id: "rift-frenzy", title: "Rift Frenzy", summary: "Four fish schools battle to convert the reef in solo or local 1-4 player chaos.", description: "A school-control fish arena: eat plankton, grow your leader, swallow smaller wild fish, and convert rival followers into your school. Solo fills the other schools with bots; local multiplayer lets up to four players fight for the biggest school before the tide timer ends.", category: "Arcade", tags: ["fish", "arena", "growth", "io", "multiplayer", "school"], contentRating: "everyone", multiplayerDescriptor: "Solo with bots or local 1-4 player keyboard multiplayer. Online room relay can wrap the same four-school rules later.", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/rift-frenzy.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["rift-frenzy"], featured: true, version: "1.1.0", controls: "P1 WASD. P2 arrows. P3 IJKL. P4 TFGH. Boost with each player's action key.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  { id: "serpent-surge", title: "Serpent Surge", summary: "A fast snake arena with rivals, pickups, cutoffs, boost trails, and storm pressure.", description: "A PhantomPlay take on snake arena games: orbit energy, grow long, bait rival serpents, use boost carefully, and survive a closing storm ring without any external networking.", category: "Strategy", tags: ["snake", "arena", "io", "survival", "touch"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/serpent-surge.html?v=1.0.4", thumbnail: GAME_ART_BY_SLUG["serpent-surge"], featured: true, version: "1.0.4", controls: "Steer with mouse, WASD, or arrows. Hold Space to boost.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "cubetown", title: "CubeTown", summary: "Build a cozy blocky town with quests, fishing, cooking, night fireflies, and Spark.", description: "A cozy town-builder with gathering, building, cooking, fishing, resident quests, and safe private-room together play.", category: "Creative", tags: ["building", "life-sim", "cozy", "farming", "multiplayer", "touch"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/cubetown/index.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["cubetown"], featured: true, version: "1.1.0", controls: "WASD/arrow keys or tap an adjacent tile. Space/E to interact.", progressSupport: true, scoreSupport: true, engine: { tier: "sandbox-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  { id: "skyguard-arena", title: "Skyguard Arena", summary: "Defend the Skyline Route with Sentinels, boss waves, and Overcharge.", description: "A lane-based tower-defense game with campaign, endless watch, skirmish, and room-duel modes.", category: "Strategy", tags: ["tower-defense", "strategy", "pvp", "waves", "touch"], contentRating: "everyone10", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/skyguard-arena/index.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["skyguard-arena"], featured: true, version: "1.1.0", controls: "Click/tap dock cards and lane slots. Q triggers Overcharge.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  { id: "keyboardist-on-tour", title: "Keyboardist On Tour", summary: "Type nonstop changing letters across three original synthesized tracks.", description: "A falling-letter rhythm game with in-browser synthesized music, Tour mode, AI rival, and Tour Duel room sync.", category: "Focus", tags: ["rhythm", "music", "keyboard", "timing", "multiplayer"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/keyboardist-on-tour.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["keyboardist-on-tour"], featured: true, version: "1.1.0", controls: "Default D/F/J/K plus Space on five-lane tracks; rebindable.", progressSupport: true, scoreSupport: true },
  { id: "tidefront-tactics", title: "Tidefront Tactics", summary: "Wind-read artillery tactics with Skiff weapons, cratered seas, bots, and boss duels.", description: "A turn-based artillery duel on a deformable heightmap sea with campaign, skirmish, and Fleet Room spectator play.", category: "Strategy", tags: ["artillery", "tactics", "turn-based", "pvp", "physics"], contentRating: "everyone10", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/tidefront-tactics.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["tidefront-tactics"], featured: true, version: "1.1.0", controls: "Arrow keys adjust angle/power, Space fires, 1/2/3 switches tools.", progressSupport: true, scoreSupport: true },
  { id: "kingdom-breakers", title: "Kingdom Breakers", summary: "Us-vs-them tower siege with Stonefall, Splinter Lance, and Emberburst shots.", description: "A physics siege/destruction game with campaign, duel mode, castles, ammo types, bot towers, and breach scoring.", category: "Strategy", tags: ["siege", "destruction", "physics", "artillery", "campaign", "pvp", "touch"], contentRating: "everyone10", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/kingdom-breakers.html?v=1.1.0", thumbnail: GAME_ART_BY_SLUG["kingdom-breakers"], featured: true, version: "1.1.0", controls: "Press and drag to aim; release to fire. 1/2/3 switches ammo.", progressSupport: true, scoreSupport: true },
  { id: "phantom-grand-prix", title: "Phantom Grand Prix", summary: "Original kart racing with drift mini-turbos, catch-up items, and three laps.", description: "A top-down arcade kart racer around Ghostlight Speedway with solo CPU racing and two-player split-screen.", category: "Arcade", tags: ["racing", "kart", "arcade", "multiplayer", "touch"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-grand-prix/index.html?v=1.0.0", thumbnail: GAME_ART_BY_SLUG["phantom-grand-prix"], featured: true, version: "1.0.0", controls: "P1: W/S/A/D, Shift drift, Space item. P2: arrows, slash drift, Enter item.", progressSupport: false, scoreSupport: false },
  ...
  { id: "crown-circuit", title: "Crown Circuit", summary: "Head-to-head three-lane elixir battler: deploy units, break towers, take the crown.", description: "A local two-player lane battler in the royale tradition with elixir, four unit cards, three lanes, and crown towers.", category: "Strategy", tags: ["strategy", "lanes", "towers", "versus", "local-multiplayer"], contentRating: "everyone10", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/crown-circuit.html?v=1.0.0", thumbnail: GAME_ART_BY_SLUG["crown-circuit"], featured: false, version: "1.0.0", controls: "P1: 1-4 choose, Q/W/E deploy. P2: 7-0 choose, I/O/P deploy.", progressSupport: false, scoreSupport: true },
];
...
function render() {
  ...
  const tabs = [["library", "Games"], ["together", "Multiplayer"], ["favorites", "Saved"], ["voice", "Voice"], ["developer", "Developers"], ...(snapshot.access.canModerate ? [["admin", "Safety Review"]] : [])];
  const content = ui.tab === "together" ? renderTogether() : ui.tab === "voice" ? `<section class="pp-section pp-voice-embed" data-pp-voice-mount></section>` : ui.tab === "favorites" ? renderFavorites() : ui.tab === "developer" ? renderDeveloper() : ui.tab === "admin" ? renderAdmin() : renderLibrary();
...
function bind() {
  ...
  const voiceMount = mountedRoot.querySelector("[data-pp-voice-mount]");
  if (voiceMount) renderVoiceChannels(voiceMount, {});
