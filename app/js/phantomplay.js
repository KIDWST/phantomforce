...
const BUILT_INS = [
  ...
  { id: "crown-circuit", title: "Crown Circuit", summary: "Solo bot training plus 8-card/4-hand elixir lane duels with battle plans, Obsidian Relay, Oracle slows, Ram sieges, and drag-and-drop deploy.", description: "A royale-style lane battler you can actually tune before the fight: choose Balanced, Siege Push, Split Swarm, Control Lock, or Tempo Cycle, then start Solo Training against Crown Bot, practice lane pressure, elixir timing, card cycling, and tower trades on multiple arenas including Obsidian Relay. Oracle cards slow threats, Ram cards pressure towers, and bots now run smarter plan-biased decks.", category: "Strategy", tags: ["card", "lane", "royale", "solo", "bots", "training", "multiplayer", "pvp", "drag-and-drop", "touch", "strategy-builds"], contentRating: "everyone10", contentDescriptors: ["strategic_complexity", "competitive_play"], multiplayerDescriptor: "Solo Training fills the rival side with Crown Bot. Room mode supports a two-player private PhantomPlay duel, one device each, with no public matchmaking, chat, or voice.", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/crown-circuit.html?v=1.3.2", thumbnail: GAME_ART_BY_SLUG["crown-circuit"], featured: true, version: "1.3.2", controls: "Pick a battle plan, build an eight-card deck, drag from the four-card hand onto your side, and cycle back to the next card. Touch or mouse.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "skyguard-arena", title: "Skyguard Arena", summary: "Bloons-style Sentinel defense with free off-road placement, one winding route, starter sentries, and three-path Sentinel upgrades.", description: "A tower-defense battle rebuilt closer to classic Bloons-style flow: one big winding route instead of split lanes, click anywhere off the road to place Sentinels, then customize each tower through Power, Reach, and Tech paths with crosspath limits. Starter sentries cover the opening route, Glint funds free placement and upgrades, Century Watch escalates toward round 100, boss mechanics rotate every 10 rounds, and private room duels stay inside PhantomPlay.", category: "Strategy", tags: ["tower-defense", "strategy", "endless", "bosses", "pvp", "waves", "tower-upgrades"], contentRating: "everyone10", contentDescriptors: ["cartoon_action", "strategic_complexity", "competitive_play"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/skyguard-arena/index.html?v=1.3.3", thumbnail: GAME_ART_BY_SLUG["skyguard-arena"], featured: true, version: "1.3.3", controls: "Choose Sentinel cards, click anywhere off the road to build, then tune Power, Reach, and Tech upgrade paths. Trigger Overcharge with Q.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
