...
function bind() {
  ...
  mountedRoot.querySelectorAll("[data-pp-devsandbox-code-open]").forEach((button) => button.onclick = (event) => { event.stopPropagation(); launchWithDevSandbox(button.dataset.ppDevsandboxCodeOpen); });
