...
const GAME_ART_BY_SLUG = {
  ...
  "phantom-legends": artUrl("phantom-legends-cover.svg"),
  ...
  "cubetown": artUrl("shadowbearer-cover.png"),
...
const BUILT_INS = [
  ...
  { id: "phantom-ages", title: "Phantom Ages", summary: "Unreal Engine 5.8 native fixed-lane age battler with troop upgrades, siege counters, faster AI, and readable formations.", description: "The canonical Phantom Ages build is the packaged Unreal-native lane war game. It stays readable like Age of War, but the native player owns the modern battlefield, literal troop upgrade paths, multi-rank ranged firing, siege units, catapult tower pressure, springald anti-siege logic, tower shots, speed controls, economy pressure, and era progression.", category: "Strategy", tags: ["unreal", "native", "strategy", "age-of-war", "lane-battle", "siege", "upgrades"], contentRating: "everyone10", contentDescriptors: ["cartoon_action", "competitive_play", "strategic_complexity"], multiplayerDescriptor: "Single-player native strategy battle. No public matchmaking, chat, voice, or external networking.", chatDescriptor: "No player chat or voice", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/native/phantom-ages?engine=unreal&version=5.8", thumbnail: GAME_ART_BY_SLUG["phantom-ages"], featured: true, version: "5.8.0-unreal", controls: "Native Unreal player. 1-5 deploy units, Q/W/E/R/T/Y buy research, A advances age, Space triggers tower volley, F1/F2/F3 set game speed.", progressSupport: true, scoreSupport: true, engine: { tier: "Unreal Engine 5.8", minVersion: PHANTOMPLAY_ENGINE.version } },
  { id: "phantom-empires", title: "Phantom Empires: Sovereign", summary: "A civilization-scale RTS with a living economy, four Ages, land and naval armies, siege warfare, weather, and a rival empire that fights back.", description: "Build a Citadel economy, command Villagers across Food, Wood, Gold, and Stone, raise Houses and military districts, advance through four Ages, train infantry, archers, cavalry, Starfall catapults, and War Galleys, control two river bridges, survive escalating Crimson war parties, and destroy the rival crown. The battlefield includes day/night and weather fronts, formations, control groups, minimap command, autosave, procedural battle audio, touch controls, Campaign, Skirmish, and Architect modes.", category: "Strategy", tags: ["rts", "civilization", "empire", "economy", "naval", "siege", "strategy", "touch"], contentRating: "everyone10", contentDescriptors: ["fantasy_conflict", "strategic_complexity", "competitive_play"], multiplayerDescriptor: "Single-player sovereign campaign and skirmish against an adaptive rival empire. No public matchmaking, chat, voice, or external networking.", chatDescriptor: "No player chat or voice", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-empires/index.html?v=1.0.0", thumbnail: GAME_ART_BY_SLUG["phantom-empires"], featured: true, version: "1.0.0", controls: "Drag to select, right-click to command, WASD pans, wheel zooms, Space arms attack-move, H centers home, F selects army, Ctrl+1-6 assigns groups. Touch command bar included.", progressSupport: true, scoreSupport: true, engine: { tier: "PhantomPlay Strategy Engine 1.0", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "phantom-rumble", title: "Phantom Rumble 3.0: Overdrive", summary: "Explosive chicken-ninja combat with MAX RUMBLE wall ricochets, OVERDRIVE surges, reactive arenas, weapons, and room play.", description: "A rebuilt high-impact arena fighter where held smashes scale for real, fully charged WALLBREAKER hits send rivals ricocheting across fences, floors, ceilings, and platforms, and every collision stacks damage with hit-stop, camera punch, haptics, arena scars, layered procedural SFX, and feather-and-spark explosions. Build OVERDRIVE through combos, master guard/parry/dodge and ledge recovery, wield six oversized weapons, trigger Ninja Mode, battle hazards across four living arenas, race to the summit, or fight solo, local, and private-room multiplayer.", category: "Arcade", tags: ["fighter", "platform", "multiplayer", "pvp", "overdrive", "wall-ricochet", "gamepad", "touch"], contentRating: "everyone10", contentDescriptors: ["cartoon_action", "competitive_play"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-rumble.html?v=3.0.0", thumbnail: GAME_ART_BY_SLUG["phantom-rumble"], featured: true, version: "3.0.0", controls: "P1: WASD, W jump, F hit, hold G for MAX RUMBLE, Q/E guard, C dodge. P2: arrows, K hit, hold L for MAX RUMBLE, I/O guard, M dodge. Gamepad and touch supported.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "cubetown", title: "Shadowbearer: Dawn's Light", summary: "A storybook action-adventure where projected light turns shadow into real paths, bridges, cover, and weapons.", description: "Begin in Bramblewick before Shadowfall, survive the unwinnable Pale Warden, restore five fallen guardians and their armaments, uncover Aktarus's complete history, and carry both light and darkness through the five-phase Black Meridian finale into Dawn's Light and a persistent First Eclipse postgame. The local PhantomPlay Unreal buildset floor is V28R6.", category: "Adventure", tags: ["unreal", "native", "storybook", "action-adventure", "memorycraft", "shadow", "exploration"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/native/cubetown?engine=unreal&version=5.8", thumbnail: GAME_ART_BY_SLUG["cubetown"], featured: true, version: "1.2.0-dawns-light · V28R6", controls: "Native Unreal player. WASD moves, mouse controls the full orbit camera, Shift sprints, Space jumps or climbs, LMB attacks, RMB guards, E interacts, Q opens Memorycraft, T uses a returned armament, and H toggles the Vestige in postgame.", progressSupport: true, scoreSupport: true, engine: { tier: "Unreal Engine 5.8 · V28R6", minVersion: PHANTOMPLAY_ENGINE.version } },
  { id: "cipher-keep", title: "Cipher Keep", summary: "A typing roguelike dungeon crawl through rooms, foes, clues, and vaults.", description: "Type words to move through a shifting procedural dungeon, defeat foes in real-time typing duels, crack sealed vaults, recover evidence for the Clue Journal, and shape the Echo Warden story through your deductions and final verdict.", category: "Focus", tags: ["typing", "roguelike", "dungeon", "keyboard", "procedural"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/cipher-keep.html?v=2.1.1", thumbnail: GAME_ART_BY_SLUG["cipher-keep"], featured: true, version: "2.1.1", controls: "Type to explore and fight. Backspace corrects mistakes. P or Esc pauses. Touch keyboard supported.", progressSupport: true, scoreSupport: true },
  ...
  { id: "vespergate", title: "Vespergate 3.1: Living Dread", summary: "A painterly portal adventure with a living Presence, six quests, two dungeons, world discovery, and Vesper mastery.", description: "The definitive top-down action-adventure across Duskhollow, Vesper Vale, the Hollow Geometry, and the Glass Ossuary. Version 3.1 restores the illustrated bearer with a pointed hood, narrow mask, asymmetric mantle, split cloak tails, and readable animation; profession-specific villagers; denser environmental life; richer rooms; persistent checkpoints; encounter objectives; bell sequences; mirror relays; and sanctum progression. It also retains the complete 3.0 feature set: touch and gamepad controls, the wayfinder map, room discovery, portal and foldshot mastery, Vesper Sense, automatic saves, 2.x migration, and portable PhantomPlay save-state handoff.", category: "Arcade", tags: ["action-adventure", "portal", "gothic", "zelda-like", "top-down", "open-world", "gamepad", "touch"], contentRating: "teen", contentDescriptors: ["fantasy_conflict", "intense_action"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/vespergate/index.html?v=3.1.0", thumbnail: GAME_ART_BY_SLUG["vespergate"], featured: true, version: "3.1.0", controls: "WASD moves; left-click strikes; F fires the full-health beam; G places gates; right-click places a gate until Vespershield unlocks, then activates the shield; Q swaps; R vents; Shift rolls; E interacts; Space uses Vesper Sense; M opens the map; Tab opens inventory; Alt+Enter toggles fullscreen. Touch and gamepad controls are built in.", progressSupport: true, scoreSupport: true },
  { id: "phantom-strike", title: "PhantomStrike", summary: "Unreal Engine 5.8 native tactical FPS with V38R10 Blackridge blue-hour payload, rifle handling, enemy squads, waves, extraction, and HUD.", description: "The canonical PhantomStrike build is the packaged Unreal-native V38R10 player installed through PhantomPlay's live buildset: modern tactical first-person movement, automatic rifle handling, aiming, recoil, reloads, headshots, hit markers, scoring, health and armor, enemy archetypes, escalating waves, extraction, and the Blackridge blue-hour operation route.", category: "Arcade", tags: ["unreal", "native", "fps", "shooter", "first-person", "bots", "tactical"], contentRating: "teen", contentDescriptors: ["intense_action", "competitive_play"], multiplayerDescriptor: "Solo Ops uses labeled enemy squads. No public matchmaking, chat, voice, or external networking.", chatDescriptor: "No player chat or voice", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/native/phantom-strike?engine=unreal&version=5.8", thumbnail: GAME_ART_BY_SLUG["phantom-strike"], featured: true, version: "1.4.0-blackridge · V38R10", controls: "Native Unreal player. Mouse looks, WASD moves, Shift sprints, Space jumps, left mouse fires, right mouse aims, R reloads.", progressSupport: true, scoreSupport: true, engine: { tier: "Unreal Engine 5.8 · V38R10", minVersion: PHANTOMPLAY_ENGINE.version } },
  { id: "phantom-legends", title: "Phantom Legends", summary: "Unreal Engine 5.8 native fantasy RTS and persistent base builder with workers, armies, towers, raids, resources, and saves.", description: "A distinct Unreal-native strategy game, separate from Phantom Ages: command workers, harvest Gold/Wood/Stone/Shards, build a stronghold, raise defenses, train guards, rangers, brutes, survive Rift raids, upgrade your base, break the Rift Gate, and keep campaign progress between sessions.", category: "Strategy", tags: ["unreal", "native", "rts", "base-builder", "fantasy", "economy", "armies"], contentRating: "everyone10", contentDescriptors: ["fantasy_conflict", "strategic_complexity", "competitive_play"], multiplayerDescriptor: "Single-player native RTS campaign foundation. No public matchmaking, chat, voice, or external networking.", chatDescriptor: "No player chat or voice", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/native/phantom-legends?engine=unreal&version=5.8", thumbnail: GAME_ART_BY_SLUG["phantom-legends"], featured: true, version: "5.8.0-unreal", controls: "Native Unreal player. WASD pans camera, left mouse selects squads, right mouse attacks, gathers, or moves, Tab selects army, 1 workers, 2 guards, 3 towers, 4 rangers, 5 brutes, U upgrades.", progressSupport: true, scoreSupport: true, engine: { tier: "Unreal Engine 5.8", minVersion: PHANTOMPLAY_ENGINE.version } },
...
function gameCard(game, variant = "") {
  ...
  return `<article class="pp-game ${variant}" data-pp-game-card="${esc(game.id)}">
    ...
    <div class="pp-game-actions"><button class="pp-play" type="button" ${launchable ? `data-pp-play="${esc(game.id)}"` : `data-pp-session-required="${esc(game.id)}"`}>${icon("play")} ${launchable ? playLabel : "Sign in to play"}</button><button class="pp-support" type="button" data-pp-support="${esc(game.developer)}">Support this creator</button>${game.devModeAvailable ? `<button class="pp-devsandbox-card-open" type="button" ${launchable ? `data-pp-devsandbox-card-open="${esc(game.id)}"` : `data-pp-session-required="${esc(game.id)}"`} aria-label="Open Dev Mode for ${esc(game.title)}" title="Dev Mode — live-edit this game's code and assets while you play, sandboxed and visible only to you">${icon("dev")}<b>Dev Mode</b></button><button class="pp-devsandbox-code-open" type="button" ${launchable ? `data-pp-devsandbox-code-open="${esc(game.id)}"` : `data-pp-session-required="${esc(game.id)}"`} aria-label="Open full source code for ${esc(game.title)}" title="Open the full game source. Edits hot-reload and autosave.">${icon("dev")}<i></i></button>` : ""}</div></div>
  </article>`;
}
    ...
    <section class="pp-hero">
      <div class="pp-console-copy">
        ...
        <div class="pp-console-actions">
          <button class="pp-primary" ${canLaunchGames() ? `data-pp-play="${esc(activeGameId)}"` : `data-pp-session-required="${esc(activeGameId)}"`}>${icon("play")} ${canLaunchGames() ? "Run quick session" : "Sign in to play"}</button>
...
function render() {
  ...
  mountedRoot.innerHTML = `<div class="pp-shell">
    <header class="pp-top"><div class="pp-title"><p class="pp-kicker">PHANTOMFORCE GAME SANDBOX</p><h1>PhantomPlay</h1></div><nav class="pp-tabs" aria-label="PhantomPlay sections">${tabs.map(([id, label]) => `<button type="button" class="${ui.tab === id ? "is-active" : ""}" data-pp-tab="${id}">${esc(label)}</button>`).join("")}</nav><div class="pp-tools"><a class="pp-secondary" href="https://github.com/KIDWST/phantomforce/releases/download/phantomplay-v0.1.0/PhantomPlay-Setup-x64.exe" target="_blank" rel="noopener" title="Free native PhantomPlay app for Windows — play, edit, and mod games with no account required">Get PhantomPlay app</a><span class="pp-access ${snapshot.access.enabled ? "is-ready" : "is-blocked"}">${snapshot.access.enabled ? esc(playTimeLabel(snapshot.access.remainingMinutesToday)) : "Sign in required"}</span><button class="pp-settings-button" data-pp-settings aria-label="Play settings">${icon("settings")}</button></div></header>
...
// Status codes worth retrying: transient/server-side. Everything else (bad
// auth, permission denied, payload rejected) will fail identically every
// time, so retrying just burns ~17s before showing the user the same result
// they'd have gotten immediately — surface it right away instead.
const DEV_SYNC_RETRYABLE_STATUSES = new Set([0, 408, 429, 500, 502, 503, 504]);

function showDevSyncFailure(gameId, message) {
...
function retryDevProjectSync(gameId, source, attempt = 0, lastError = null) {
  ...
  if (attempt >= delays.length) {
    ...
    showDevSyncFailure(gameId, `Couldn't save your changes to your account after several tries — Normal Mode will keep showing your last saved version until this succeeds. Click Save to try again.${detail}`);
    return;
  }
  setTimeout(async () => {
    try {
      ...
      console.error("PhantomPlay dev-mode save failed", error);
      if (error?.status && !DEV_SYNC_RETRYABLE_STATUSES.has(error.status)) {
        showDevSyncFailure(gameId, error.message || "This edit could not be saved.");
        return;
      }
      retryDevProjectSync(gameId, source, attempt + 1, error);
    }
  }, delays[attempt]);
}
...
async function persistPlay(ended, detail = {}) {
  ...
  const row = { gameId: ui.player.game.id, lastPlayedAt: new Date().toISOString(), score: Math.max(existing?.score || 0, ui.player.play.score || 0), progress, seconds: (existing?.seconds || 0) + delta, state, canContinue: progress < 100 && (progress > 0 || hasState) };
...
async function closePlayer() {
  ...
  const finalDetailPromise = requestFinalGameSave();
  if (document.fullscreenElement) await document.exitFullscreen?.().catch(() => undefined);
  clearInterval(playClock);
  clearTimeout(readyWatchdog);
  clearTimeout(devSandboxApplyTimer);
  clearTimeout(devSandboxAutosaveTimer);
  const finalDetail = await finalDetailPromise;
  revokeDevSandboxBlob();
  revokePlayerOverrideBlob();
  ui.devSandbox = null;
