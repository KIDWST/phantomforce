...
const BUILT_INS = [
  ...
  { id: "phantom-strike", title: "Phantom Strike", summary: "First-person tactical arena combat with weapon builds, bots, three maps, and real local split-screen.", description: "A network-silent first-person ray-cast shooter with Solo Ops against a bot squad, genuine same-device 1v1 split-screen, three compact maps, rifle/SMG/shotgun builds, optics, barrels, hit feedback, respawns, and an after-action report.", category: "Arcade", tags: ["fps", "shooter", "first-person", "bots", "multiplayer", "split-screen"], contentRating: "teen", contentDescriptors: ["intense_action", "competitive_play"], multiplayerDescriptor: "Local 1v1 is real same-device split-screen. Solo Ops uses clearly labeled bots. No public matchmaking, chat, voice, or external networking.", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/phantom-strike.html?v=1.0.0", thumbnail: GAME_ART_BY_SLUG["phantom-strike"], featured: true, version: "1.0.0", controls: "P1 WASD, Q/E turn, F or Space fire. P2 arrows turn/move, comma/period strafe, Enter or slash fire.", progressSupport: true, scoreSupport: true, engine: { tier: "raycast-fps", minVersion: PHANTOMPLAY_ENGINE.version } },
