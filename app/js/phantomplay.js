...
} from "./store.js?v=phantom-live-20260821-191";
...
const BUILT_INS = [
  ...
  { id: "cubetown", title: "Shadowbearer: Dawn's Return", summary: "A storybook action-adventure where projected light turns shadow into real paths, bridges, cover, and weapons.", description: "Begin in Bramblewick before Shadowfall, survive the unwinnable Pale Warden, restore five fallen guardians and their armaments, uncover Aktarus's complete history, and carry both light and darkness through the five-phase Black Meridian finale into Dawn's Return and a persistent First Eclipse postgame.", category: "Adventure", tags: ["unreal", "native", "storybook", "action-adventure", "memorycraft", "shadow", "exploration"], contentRating: "everyone", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/native/cubetown?engine=unreal&version=5.8", thumbnail: GAME_ART_BY_SLUG["cubetown"], featured: true, version: "1.0.1-dawns-return", controls: "Native Unreal player. WASD moves, mouse controls the full orbit camera, Shift sprints, Space jumps or climbs, LMB attacks, RMB guards, E interacts, Q opens Memorycraft, T uses a returned armament, and H toggles the Vestige in postgame.", progressSupport: true, scoreSupport: true, engine: { tier: "Unreal Engine 5.8", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "phantom-strike", title: "Phantom Strike", summary: "Unreal Engine 5.8 native tactical FPS with rifle handling, enemy squads, waves, extraction, HUD, and a neon command complex.", description: "The canonical Phantom Strike build is the packaged Unreal-native player: modern tactical first-person movement, automatic rifle handling, aiming, recoil, reloads, headshots, hit markers, scoring, health and armor, enemy archetypes, escalating waves, extraction, and procedural near-future combat spaces.", category: "Arcade", tags: ["unreal", "native", "fps", "shooter", "first-person", "bots", "tactical"], contentRating: "teen", contentDescriptors: ["intense_action", "competitive_play"], multiplayerDescriptor: "Solo Ops uses labeled enemy squads. No public matchmaking, chat, voice, or external networking.", chatDescriptor: "No player chat or voice", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/native/phantom-strike?engine=unreal&version=5.8", thumbnail: GAME_ART_BY_SLUG["phantom-strike"], featured: true, version: "5.8.0-unreal", controls: "Native Unreal player. Mouse looks, WASD moves, Shift sprints, Space jumps, left mouse fires, right mouse aims, R reloads.", progressSupport: true, scoreSupport: true, engine: { tier: "Unreal Engine 5.8", minVersion: PHANTOMPLAY_ENGINE.version } },
