...
} from "./store.js?v=phantom-live-20260721-27";
...
const BUILT_INS = [
  ...
  { id: "crown-circuit", title: "Crown Circuit", summary: "Solo bot training plus 8-card/4-hand elixir lane duels with Obsidian Relay, Oracle slows, Ram sieges, and drag-and-drop deploy.", description: "A royale-style lane battler you can actually learn alone: start Solo Training against Crown Bot, practice lane pressure, elixir timing, card cycling, and tower trades on multiple arenas including Obsidian Relay, then take the same drag-and-drop troop duel into a private PhantomPlay room. Oracle cards slow threats, Ram cards pressure towers, and bots now cycle an upgraded deck.", category: "Strategy", tags: ["card", "lane", "royale", "solo", "bots", "training", "multiplayer", "pvp", "drag-and-drop", "touch"], contentRating: "everyone10", contentDescriptors: ["strategic_complexity", "competitive_play"], multiplayerDescriptor: "Solo Training fills the rival side with Crown Bot. Room mode supports a two-player private PhantomPlay duel, one device each, with no public matchmaking, chat, or voice.", developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/crown-circuit.html?v=1.3.1", thumbnail: GAME_ART_BY_SLUG["crown-circuit"], featured: true, version: "1.3.1", controls: "Build an eight-card deck, drag from the four-card hand onto your side, and cycle back to the next card. Touch or mouse.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
  ...
  { id: "skyguard-arena", title: "Skyguard Arena", summary: "Bloons-style Sentinel defense with free off-road placement, one winding route, starter sentries, and escalating boss rounds.", description: "A tower-defense battle rebuilt closer to classic Bloons-style flow: one big winding route instead of split lanes, click anywhere off the road to place Sentinels, and round one starts with a single Driftling so players can learn the loop before pressure ramps. Starter sentries cover the opening route, Glint funds free placement and upgrades, Century Watch escalates toward round 100, boss mechanics rotate every 10 rounds, and private room duels stay inside PhantomPlay.", category: "Strategy", tags: ["tower-defense", "strategy", "endless", "bosses", "pvp", "waves"], contentRating: "everyone10", contentDescriptors: ["cartoon_action", "strategic_complexity", "competitive_play"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/skyguard-arena/index.html?v=1.3.2", thumbnail: GAME_ART_BY_SLUG["skyguard-arena"], featured: true, version: "1.3.2", controls: "Choose Sentinel cards, then click anywhere off the road to build. Upgrade, sell, and trigger Overcharge with Q.", progressSupport: true, scoreSupport: true, engine: { tier: "arena-large-map", minVersion: PHANTOMPLAY_ENGINE.version } },
