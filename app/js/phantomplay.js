...
const BUILT_INS = [
  ...
  { id: "vespergate", title: "Vespergate: The Vesper Hand", summary: "A painterly top-down portal adventure with a clearer bearer, ornate dusk UI, a village to save, and two dungeons.", description: "An original top-down action-adventure set across Duskhollow village, an open vale, the Hollow Geometry, and the Glass Ossuary. Strike, fire cinder bolts, and place two linked Vesper Gates that preserve momentum for you, projectiles, enemies, and bell shockwaves. Complete six quests, earn and equip relics, master bank shots and portal folds, defeat Bellmother and the Choir of Glass, then bring evensong home. Version 2.4.3 adds the illustrated Vespergate art pass: a readable hooded bearer, warmer cottage/interior lighting, ornate gold-framed HUD panels, darker blue-violet stone, copper seams, and etched board texture.", category: "Arcade", tags: ["action-adventure", "portal", "gothic", "zelda-like", "top-down", "open-world", "gamepad"], contentRating: "teen", contentDescriptors: ["fantasy_conflict", "intense_action"], developer: "Tak", developerAvatar: TAK_AVATAR, kind: "built_in", launchUrl: "/app/games/vespergate/index.html?v=2.4.3", thumbnail: GAME_ART_BY_SLUG["vespergate"], featured: true, version: "2.4.3", controls: "WASD moves, left-click strikes, F fires, right-click places a gate, Q swaps, R vents, Shift rolls, E interacts, Tab opens inventory, and Alt+Enter toggles fullscreen. Full gamepad support.", progressSupport: true, scoreSupport: true },
