...
} from "./proposalpipeline.js?v=phantom-live-20260723-44";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260723-44";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260723-44";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260723-44")
