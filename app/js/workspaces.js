...
} from "./orgs.js?v=phantom-live-20260723-35";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260723-35";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260723-35";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260723-35")
