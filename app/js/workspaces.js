...
import {
  ...
  session,
} from "./store.js?v=phantom-live-20260721-13";
import {
...
} from "./orgs.js?v=phantom-live-20260721-13";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260721-13";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260721-13";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260721-13")
