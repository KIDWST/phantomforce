...
} from "./proposalpipeline.js?v=phantom-live-20260819-167";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260819-167";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260819-167";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260819-167";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260819-167")
