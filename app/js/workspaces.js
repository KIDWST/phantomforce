...
import {
  ...
  session,
} from "./store.js?v=phantom-live-20260719-48";
import {
...
} from "./orgs.js?v=phantom-live-20260719-48";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260719-48";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260719-48";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260719-48")
