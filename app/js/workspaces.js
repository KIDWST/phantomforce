...
} from "./proposalpipeline.js?v=phantom-live-20260914-216";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260914-216";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260914-216";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260914-216";
import { mountProductionCorePanel } from "./production-core.js?v=phantom-live-20260914-216";
import { getEmailConnectionSnapshot } from "./connection-center.js?v=phantom-live-20260914-216";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260914-216")
