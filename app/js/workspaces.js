...
} from "./proposalpipeline.js?v=phantom-live-20260819-173";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260819-173";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260819-173";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260819-173";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260819-173")
