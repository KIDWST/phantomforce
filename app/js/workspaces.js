...
} from "./proposalpipeline.js?v=phantom-live-20260819-182";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260819-182";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260819-182";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260819-182";
import { mountProductionCorePanel } from "./production-core.js?v=phantom-live-20260819-182";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260819-182")
