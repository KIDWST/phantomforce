...
} from "./orgs.js?v=phantom-live-20260722-24";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260722-24";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260722-24";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260722-24")
