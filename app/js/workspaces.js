...
} from "./orgs.js?v=phantom-live-20260728-67";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260728-67";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260728-67";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260728-67";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260728-67";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260728-67")
