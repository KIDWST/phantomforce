...
} from "./orgs.js?v=phantom-live-20260728-68";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260728-68";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260728-68";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260728-68";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260728-68";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260728-68")
