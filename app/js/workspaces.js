...
} from "./proposalpipeline.js?v=phantom-live-20260723-40";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260723-40";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260723-40";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260723-40")
