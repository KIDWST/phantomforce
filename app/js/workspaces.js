...
} from "./orgs.js?v=phantom-live-20260722-4";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260722-4";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260722-4";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260722-4")
