...
} from "./orgs.js?v=phantom-live-20260723-61";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260723-61";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260723-61";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260723-61";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260723-61";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260723-61")
