...
} from "./proposalpipeline.js?v=phantom-live-20260723-43";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260723-43";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260723-43";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260723-43")
