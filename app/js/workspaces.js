...
} from "./proposalpipeline.js?v=phantom-live-20260914-219";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260914-219";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260914-219";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260914-219";
import { mountProductionCorePanel } from "./production-core.js?v=phantom-live-20260914-219";
import { getEmailConnectionSnapshot } from "./connection-center.js?v=phantom-live-20260914-219";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260914-219")
