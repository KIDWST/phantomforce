...
/* one place for recurring price suffixes so every store renderer stays
   consistent when a public-site starter mixes free, one-time, and monthly items. */
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260716-285")
