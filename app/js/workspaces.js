...
} from "./proposalpipeline.js?v=phantom-live-20260819-177";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260819-177";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260819-177";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260819-177";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260819-177")
