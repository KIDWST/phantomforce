...
import {
  ...
  session,
} from "./store.js?v=phantom-live-20260719-45";
import {
...
} from "./orgs.js?v=phantom-live-20260719-45";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260719-45";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260719-45";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260719-45")
