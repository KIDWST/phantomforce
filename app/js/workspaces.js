...
} from "./proposalpipeline.js?v=phantom-live-20260822-197";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260822-197";
import {
  ...
  financeContentKey,
} from "./financeledger.js?v=phantom-live-20260822-197";
import { createScopedSelection, productStateHtml } from "./product-grammar.js?v=phantom-live-20260822-197";
import { mountProductionCorePanel } from "./production-core.js?v=phantom-live-20260822-197";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260822-197")
