...
} from "./orgs.js?v=phantom-live-20260719-64";
import {
...
} from "./proposalpipeline.js?v=phantom-live-20260719-64";
import {
...
} from "./approvalpipeline.js?v=phantom-live-20260719-64";
...
function renderMemory(el, rerender) {
  ...
  if (brainPanel) {
    brainPanel.addEventListener("toggle", () => {
      ...
      import("./brain.js?v=phantom-live-20260719-64")
