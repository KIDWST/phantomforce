...
} from "./store.js?v=phantom-live-20260710-151";
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260710-151";
import { WORKSPACE_DEFS, missionWidgets, esc, buildWorkerRoster } from "./workspaces.js?v=phantom-live-20260710-151";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260710-151";
import { renderMediaStudio, DEFAULT_PROVIDERS } from "./medialab.js?v=phantom-live-20260710-151";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260710-151";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260710-151";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260710-151";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260710-151";
import { renderAutomation } from "./brandops.js?v=phantom-live-20260710-151";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260710-151";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260710-151";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260710-151";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode } from "./companion.js?v=phantom-live-20260710-151";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260710-151";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260710-151";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260710-151";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260710-151";
let phantom3d = null;
