...
} from "./store.js?v=phantom-live-20260712-228";
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260712-228";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260712-228";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260712-228";
import { renderMediaStudio, DEFAULT_PROVIDERS } from "./medialab.js?v=phantom-live-20260712-228";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260712-228";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260712-228";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260712-228";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260712-228";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260712-228";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260712-228";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260712-228";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260712-228";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode } from "./companion.js?v=phantom-live-20260712-228";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260712-228";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260712-228";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260712-228";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260712-228";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260712-228";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260712-228";
import {
  fetchAuthConfig, databaseLogin, databaseLogout, switchOrg, fetchAuthMe, fetchEntitlementsSummary,
} from "./orgs.js?v=phantom-live-20260712-228";
import { renderAssetCloud } from "./assetcloud.js?v=phantom-live-20260712-228";
import { assetsAvailable } from "./orgs.js?v=phantom-live-20260712-228";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260712-228";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260712-228";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260712-228";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260712-228";
let phantom3d = null;
