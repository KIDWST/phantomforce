...
} from "./store.js?v=phantom-live-20260707-52";
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260707-52";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260707-52";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260707-52";
import { renderMediaStudio } from "./medialab.js?v=phantom-live-20260707-52";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260707-52";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260707-52";
import { renderFlowMap } from "./flowmap.js?v=phantom-live-20260707-52";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260707-52";
import { renderAutomation } from "./brandops.js?v=phantom-live-20260707-52";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode } from "./companion.js?v=phantom-live-20260707-52";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260707-52";
import { getOperatorSettings, renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260707-52";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260707-52";
let phantom3d = null;
