...
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260722-3";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260722-3";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260722-3";
import { renderMediaStudio, DEFAULT_PROVIDERS } from "./medialab.js?v=phantom-live-20260722-3";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260722-3";
import { mountManagedGrowthReport } from "./managedgrowth.js?v=phantom-live-20260722-3";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260722-3";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260722-3";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260722-3";
import { mountPhantomAI } from "./phantomai.js?v=phantom-live-20260722-3";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260722-3";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260722-3";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260722-3";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260722-3";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode, refreshCompanionCore } from "./companion.js?v=phantom-live-20260722-3";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260722-3";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260722-3";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260722-3";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260722-3";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260722-3";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260722-3";
import {
...
import { renderAssetCloud } from "./assetcloud.js?v=phantom-live-20260722-3";
import { assetsAvailable } from "./orgs.js?v=phantom-live-20260722-3";
import { renderPhantomStore } from "./phantomstore.js?v=phantom-live-20260722-3";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260722-3";
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260722-3";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260722-3";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260722-3";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260722-3";
import { initCommandOS, applyCommandExecutionMode } from "./command-os.js?v=phantom-live-20260722-3";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260722-3";
let phantom3d = null;
