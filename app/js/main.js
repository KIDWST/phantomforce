...
} from "./store.js?v=phantom-live-20260711-156";
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260711-156";
import { WORKSPACE_DEFS, missionWidgets, esc, buildWorkerRoster } from "./workspaces.js?v=phantom-live-20260711-156";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260711-156";
import { renderMediaStudio, DEFAULT_PROVIDERS } from "./medialab.js?v=phantom-live-20260711-156";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260711-156";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260711-156";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260711-156";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260711-156";
import { renderAutomation } from "./brandops.js?v=phantom-live-20260711-156";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260711-156";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260711-156";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260711-156";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode } from "./companion.js?v=phantom-live-20260711-156";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260711-156";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260711-156";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260711-156";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260711-156";
let phantom3d = null;
