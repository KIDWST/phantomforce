...
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260714-261";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260714-261";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260714-261";
import { renderMediaStudio, DEFAULT_PROVIDERS } from "./medialab.js?v=phantom-live-20260714-261";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260714-261";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260714-261";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260714-261";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260714-261";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260714-261";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260714-261";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260714-261";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260714-261";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode } from "./companion.js?v=phantom-live-20260714-261";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260714-261";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260714-261";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260714-261";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260714-261";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260714-261";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260714-261";
import {
...
} from "./orgs.js?v=phantom-live-20260714-261";
import { renderAssetCloud } from "./assetcloud.js?v=phantom-live-20260714-261";
import { assetsAvailable } from "./orgs.js?v=phantom-live-20260714-261";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260714-261";
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260714-261";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260714-261";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260714-261";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260714-261";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260714-261";
let phantom3d = null;
