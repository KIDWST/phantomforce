...
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260719-47";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260719-47";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260719-47";
import { renderMediaStudio, DEFAULT_PROVIDERS } from "./medialab.js?v=phantom-live-20260719-47";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260719-47";
import { mountManagedGrowthReport } from "./managedgrowth.js?v=phantom-live-20260719-47";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260719-47";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260719-47";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260719-47";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260719-47";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260719-47";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260719-47";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260719-47";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode } from "./companion.js?v=phantom-live-20260719-47";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260719-47";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260719-47";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260719-47";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260719-47";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260719-47";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260719-47";
import {
...
import { renderAssetCloud } from "./assetcloud.js?v=phantom-live-20260719-47";
import { assetsAvailable } from "./orgs.js?v=phantom-live-20260719-47";
import { renderPhantomStore } from "./phantomstore.js?v=phantom-live-20260719-47";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260719-47";
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260719-47";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260719-47";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260719-47";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260719-47";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260719-47";
let phantom3d = null;
