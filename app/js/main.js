...
} from "./organizationpulse.js?v=phantom-live-20260723-57";
...
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260723-57";
import { mountPhantomAI } from "./phantomai.js?v=phantom-live-20260723-57";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260723-57";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260723-57";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260723-57";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260723-57";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode, refreshCompanionCore } from "./companion.js?v=phantom-live-20260723-57";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260723-57";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260723-57";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260723-57";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260723-57";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260723-57";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260723-57";
import {
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260723-57";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260723-57";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260723-57";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260723-57";
import { initCommandOS, applyCommandExecutionMode } from "./command-os.js?v=phantom-live-20260723-57";
import { createRouteRegistry } from "./product-grammar.js?v=phantom-live-20260723-57";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260723-57";
let phantom3d = null;
