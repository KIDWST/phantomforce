...
} from "./organizationpulse.js?v=phantom-live-20260726-66";
import {
...
} from "./securitystatus.js?v=phantom-live-20260726-66";
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260726-66";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260726-66";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260726-66";
import { renderUnifiedAnalytics } from "./analytics-hub.js?v=phantom-live-20260726-66";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260726-66";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260726-66";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260726-66";
import { mountPhantomAI } from "./phantomai.js?v=phantom-live-20260726-66";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260726-66";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260726-66";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260726-66";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260726-66";
import { setCompanionState, setCompanionMode, companionMode, refreshCompanionCore } from "./companion.js?v=phantom-live-20260726-66";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260726-66";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260726-66";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260726-66";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260726-66";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260726-66";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260726-66";
import {
...
} from "./orgs.js?v=phantom-live-20260726-66";
import { renderPhantomStore } from "./phantomstore.js?v=phantom-live-20260726-66";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260726-66";
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260726-66";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260726-66";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260726-66";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260726-66";
import { initCommandOS, applyCommandExecutionMode } from "./command-os.js?v=phantom-live-20260726-66";
import { createRouteRegistry } from "./product-grammar.js?v=phantom-live-20260726-66";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260726-66";
let phantom3d = null;
