...
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260717-16";
import { WORKSPACE_DEFS, missionWidgets, esc, DEPARTMENTS } from "./workspaces.js?v=phantom-live-20260717-16";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260717-16";
import { renderMediaStudio, DEFAULT_PROVIDERS } from "./medialab.js?v=phantom-live-20260717-16";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260717-16";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260717-16";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260717-16";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260717-16";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260717-16";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260717-16";
import { renderPlanner } from "./planner.js?v=phantom-live-20260717-16";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260717-16";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260717-16";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode } from "./companion.js?v=phantom-live-20260717-16";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260717-16";
import { renderOperatorMiniSettings, renderOperatorSettings, renderOwnerAdminControl } from "./settings.js?v=phantom-live-20260717-16";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260717-16";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260717-16";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260717-16";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260717-16";
import {
...
import { renderAssetCloud } from "./assetcloud.js?v=phantom-live-20260717-16";
import { assetsAvailable } from "./orgs.js?v=phantom-live-20260717-16";
import { renderPhantomStore } from "./phantomstore.js?v=phantom-live-20260717-16";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260717-16";
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260717-16";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260717-16";
import {
  canAccessConfiguredModule,
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260717-16";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260717-16";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260717-16";
let phantom3d = null;
