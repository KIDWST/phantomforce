...
} from "./store.js?v=phantom-live-20260711-186";
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260711-186";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260711-186";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260711-186";
import { renderMediaStudio, DEFAULT_PROVIDERS } from "./medialab.js?v=phantom-live-20260711-186";
import { renderContentHub, renderAnalytics } from "./contenthub.js?v=phantom-live-20260711-186";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260711-186";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260711-186";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260711-186";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260711-186";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260711-186";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260711-186";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260711-186";
import { mountCompanion, setCompanionState, setCompanionMode, companionMode } from "./companion.js?v=phantom-live-20260711-186";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260711-186";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260711-186";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260711-186";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260711-186";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260711-186";
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260711-186";
let phantom3d = null;
