...
} from "./organizationpulse.js?v=phantom-live-20260723-62";
import {
...
} from "./securitystatus.js?v=phantom-live-20260723-62";
import { handleCommand, handleSmartCommand, commandSuggestions } from "./command.js?v=phantom-live-20260723-62";
import { WORKSPACE_DEFS, missionWidgets, esc } from "./workspaces.js?v=phantom-live-20260723-62";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260723-62";
import { renderAnalytics } from "./contenthub.js?v=phantom-live-20260723-62";
import { mountManagedGrowthReport } from "./managedgrowth.js?v=phantom-live-20260723-62";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260723-62";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260723-62";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260723-62";
import { mountPhantomAI } from "./phantomai.js?v=phantom-live-20260723-62";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260723-62";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260723-62";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260723-62";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260723-62";
import { setCompanionState, setCompanionMode, companionMode, refreshCompanionCore } from "./companion.js?v=phantom-live-20260723-62";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260723-62";
import { renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260723-62";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260723-62";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260723-62";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260723-62";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260723-62";
import {
...
import { renderAssetCloud } from "./assetcloud.js?v=phantom-live-20260723-62";
import { assetsAvailable } from "./orgs.js?v=phantom-live-20260723-62";
import { renderPhantomStore } from "./phantomstore.js?v=phantom-live-20260723-62";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260723-62";
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260723-62";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260723-62";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260723-62";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260723-62";
import { initCommandOS, applyCommandExecutionMode } from "./command-os.js?v=phantom-live-20260723-62";
import { createRouteRegistry } from "./product-grammar.js?v=phantom-live-20260723-62";
...
const PLAN_NAV_WORKFLOWS = {
  ...
  developer: new Set(["dashboard", "phantomai", "sites", "assets", "automation", "developer", "phantomplay", "phantomstore", "settings"]),
  elite: new Set(["dashboard", "phantomai", "crm", "assets", "sites", "money", "automation", "approvals", "workers", "intelligence", "analytics", "phantomplay", "phantomstore", "settings", "vacation"]),
  developer_elite: new Set(["dashboard", "phantomai", "crm", "assets", "sites", "money", "automation", "approvals", "workers", "intelligence", "analytics", "developer", "phantomplay", "phantomstore", "settings", "vacation"]),
  enterprise: null,
  internal: null,
  phantom: null,
};
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260723-62";
let phantom3d = null;
