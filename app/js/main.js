...
} from "./organizationpulse.js?v=phantom-live-20260819-183";
import {
...
} from "./securitystatus.js?v=phantom-live-20260819-183";
import { handleCommand, handleSmartCommand } from "./command.js?v=phantom-live-20260819-183";
import { WORKSPACE_DEFS, missionWidgets, esc, selectAccountingTab } from "./workspaces.js?v=phantom-live-20260819-183";
import { renderOrganizationPanel } from "./organization.js?v=phantom-live-20260819-183";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260819-183";
import { renderUnifiedAnalytics } from "./analytics-hub.js?v=phantom-live-20260819-183";
import { renderMediaStudio } from "./medialab.js?v=phantom-live-20260819-183";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260819-183";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260819-183";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260819-183";
import { mountPhantomAI } from "./phantomai.js?v=phantom-live-20260819-183";
import { renderPhantomHunter } from "./phantomhunter.js?v=phantom-live-20260819-183";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260819-183";
import { renderPlanner } from "./planner.js?v=phantom-live-20260819-183";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260819-183";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260819-183";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260819-183";
import { setCompanionState, setCompanionMode, companionMode, refreshCompanionCore } from "./companion.js?v=phantom-live-20260819-183";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260819-183";
import { getOperatorInfrastructureStatus, getOperatorSettings, hydrateOperatorRuntimeSettings, renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260819-183";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260819-183";
import { mountBuddy, buddyReact } from "./buddy.js?v=phantom-live-20260819-183";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260819-183";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260819-183";
import { registerContentAsset, renderContentHub } from "./contenthub.js?v=phantom-live-20260819-183";
import {
...
} from "./orgs.js?v=phantom-live-20260819-183";
import { renderPhantomStore } from "./phantomstore.js?v=phantom-live-20260819-183";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260819-183";
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260819-183";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260819-183";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260819-183";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260819-183";
import { initCommandOS, applyCommandExecutionMode } from "./command-os.js?v=phantom-live-20260819-183";
import { createRouteRegistry } from "./product-grammar.js?v=phantom-live-20260819-183";
...
const WORKSPACE_STYLE_BUNDLES = Object.freeze({
  phantomplay: [
    "/app/phantomplay.css?v=phantom-live-20260819-183",
    "/app/phantomplay-v2.css?v=phantom-live-20260819-183",
  ],
  phantomstore: ["/app/phantomstore.css?v=phantom-live-20260819-183"],
  phantomai: ["/app/creator-studio.css?v=phantom-live-20260819-183"],
  phantomhunter: [
    "/app/phantomhunter.css?v=phantom-live-20260819-183",
    "/app/phantomhunter-connect.css?v=phantom-live-20260819-183",
  ],
  media: ["/app/creator-studio.css?v=phantom-live-20260819-183"],
  content: ["/app/creator-studio.css?v=phantom-live-20260819-183"],
});
...
function showWorkspaceTransition(transition, phase = "loading") {
  ...
  transition.node.innerHTML = `<div class="workspace-transition-card">
    <div class="workspace-transition-mark" aria-hidden="true"><img src="/app/assets/brand-phantom.png?v=phantom-live-20260819-183" alt=""><i></i><i></i></div>
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260819-183";
let phantom3d = null;
