...
} from "./store.js?v=phantom-live-20260914-215";
import {
  loadOrganizationPulse, loadBrainContract, pulseAttentionItems, brainContractAttentionItems, cachedOrganizationPulse,
} from "./organizationpulse.js?v=phantom-live-20260914-215";
import { handleCommand, handleSmartCommand } from "./command.js?v=phantom-live-20260914-215";
import { WORKSPACE_DEFS, missionWidgets, esc, selectAccountingTab } from "./workspaces.js?v=phantom-live-20260914-215";
import { renderOrganizationPanel } from "./organization.js?v=phantom-live-20260914-215";
import { createPhantomCharacter } from "./character.js?v=phantom-live-20260914-215";
import { renderUnifiedAnalytics } from "./analytics-hub.js?v=phantom-live-20260914-215";
import { renderMediaStudio } from "./medialab.js?v=phantom-live-20260914-215";
import { createPhantomStage3D } from "./phantom-3d.js?v=phantom-live-20260914-215";
import { renderFlowMap, flowSummary } from "./flowmap.js?v=phantom-live-20260914-215";
import { mountPhantomWire, mountAgentConsole } from "./agentops.js?v=phantom-live-20260914-215";
import { mountPhantomAI, queuePhantomAiPrompt } from "./phantomai.js?v=phantom-live-20260914-215";
import { renderPhantomHunter } from "./phantomhunter.js?v=phantom-live-20260914-215";
import { renderAutomation, renderDeveloperAutopilotPanel, renderDeveloperAgentRunsPanel } from "./brandops.js?v=phantom-live-20260914-215";
import { renderPlanner } from "./planner.js?v=phantom-live-20260914-215";
import { renderVacationMode, cachedVacationStatus } from "./vacation.js?v=phantom-live-20260914-215";
import { renderSiteStudio } from "./sitestudio.js?v=phantom-live-20260914-215";
import { renderPromptLibrary } from "./promptlibrary.js?v=phantom-live-20260914-215";
import { setCompanionState, setCompanionMode, companionMode, refreshCompanionCore } from "./companion.js?v=phantom-live-20260914-215";
import { mountDesktopContextWidget } from "./desktop-context.js?v=phantom-live-20260914-215";
import { getOperatorInfrastructureStatus, getOperatorSettings, hydrateOperatorRuntimeSettings, renderOperatorMiniSettings, renderOperatorSettings } from "./settings.js?v=phantom-live-20260914-215";
import { getRembgStatus, getMediaEngineHealth } from "./mediabackend.js?v=phantom-live-20260914-215";
import { mountAmbient } from "./ambient.js?v=phantom-live-20260914-215";
import { renderCompetitorIntelligence } from "./competitor-intelligence.js?v=phantom-live-20260914-215";
import { registerContentAsset, renderContentHub } from "./contenthub.js?v=phantom-live-20260914-215";
import { renderChicagoShotsStudio } from "./chicagoshots-studio.js?v=phantom-live-20260914-215";
import {
...
} from "./orgs.js?v=phantom-live-20260914-215";
import { renderPhantomStore } from "./phantomstore.js?v=phantom-live-20260914-215";
import { renderPhantomPlay } from "./phantomplay.js?v=phantom-live-20260914-215";
...
import { renderPhantomPlay as renderPhantomPlayV2 } from "./phantomplay-v2.js?v=phantom-live-20260914-215";
const phantomPlayV2Opted = () => { try { return localStorage.getItem("pf.phantomplay.v2") === "1"; } catch { return false; } };
import { pageWorkerHtml, mountPageWorkers } from "./pageworker.js?v=phantom-live-20260914-215";
import {
  customizeNavigation,
  loadOrganizationCustomization,
} from "./customization.js?v=phantom-live-20260914-215";
import { mountMissionControl } from "./missioncontrol.js?v=phantom-live-20260914-215";
import { initCommandOS, applyCommandExecutionMode } from "./command-os.js?v=phantom-live-20260914-215";
import { createRouteRegistry } from "./product-grammar.js?v=phantom-live-20260914-215";
...
const WORKSPACE_STYLE_BUNDLES = Object.freeze({
  phantomplay: [
    "/app/phantomplay.css?v=phantom-live-20260914-215",
    "/app/phantomplay-v2.css?v=phantom-live-20260914-215",
  ],
  phantomstore: ["/app/phantomstore.css?v=phantom-live-20260914-215"],
  phantomai: ["/app/creator-studio.css?v=phantom-live-20260914-215"],
  phantomhunter: [
    "/app/phantomhunter.css?v=phantom-live-20260914-215",
    "/app/phantomhunter-connect.css?v=phantom-live-20260914-215",
  ],
  media: ["/app/creator-studio.css?v=phantom-live-20260914-215"],
  content: ["/app/creator-studio.css?v=phantom-live-20260914-215"],
  chicagoshots: ["/app/chicagoshots-studio.css?v=phantom-live-20260914-215"],
});
...
function showWorkspaceTransition(transition, phase = "loading") {
  ...
  transition.node.innerHTML = `<div class="workspace-transition-card">
    <div class="workspace-transition-mark" aria-hidden="true"><img src="/app/assets/brand-phantom.png?v=phantom-live-20260914-215" alt=""><i></i><i></i></div>
...
const openNavTabs = new Set(["dashboard", "media", "content", "analytics", "leads", "bookings", "money", "sites", "approvals", "riskwatch"]);
...
function renderOsMenu() {
  ...
  const primaryIds = ["dashboard", "leads", "comms", "bookings", "money", "media", "content", "sites", "approvals", "riskwatch", "analytics", "phantomai", "automation", "intelligence", "runtime", "phantomhunter", "audit", "notifications", "planner", "vacation", "memory", "settings", "adminos", "developer", "phantomplay", "phantomstore"];
  const items = orderedNavItems()
...
let activeMode = "ask";
const POSE_VERSION = "phantom-live-20260914-215";
let phantom3d = null;
