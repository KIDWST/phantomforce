...
Set-Content -LiteralPath (Join-Path $Candidate 'PHANTOM_V27R1_CANDIDATE.txt') -Encoding UTF8 -Value @(
    'PHANTOM V27R1 CANDIDATE'
    'game=phantom-strike'
...
$Manifest | ConvertTo-Json -Depth 8 | Set-Content -LiteralPath (Join-Path $Candidate 'PHANTOM_V27R1_MANIFEST.json') -Encoding UTF8
