...
$CandidateRoot = [IO.Path]::GetFullPath((Join-Path $ProjectRoot 'CandidateBuilds\Shadowbearer-Dawns-Return-V25R16\cubetown'))
...
$BackupRoot = Assert-Within (Join-Path $BackupParent "shadowbearer-v25r16-$Timestamp") $BackupParent 'Rollback checkpoint'
