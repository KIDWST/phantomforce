...
TIPS = [
    ...
    "agent.tool_use_enforcement is model-neutral — auto applies the execute/verify contract to every model when tools are loaded.",
    "agent.text_tool_fallback lets text-output models without native function calling use PhantomBot's normal validated tools through compatibility mode.",
