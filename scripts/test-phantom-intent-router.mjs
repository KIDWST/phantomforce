...
assert.deepEqual(capturedChatBody.allowed_providers, ["deepseek_api", "local_ollama", "codex_cli", "claude_cli", "openrouter_glm", "chatgpt_bridge", "hermes"], "the request must carry the configured user-selectable provider set, including the live Hermes route");
