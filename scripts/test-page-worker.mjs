...
assert.match(main, /import \{ pageWorkerHtml, mountPageWorkers \} from "\.\/pageworker\.js\?v=phantom-live-20260712-227"/u, "main.js must import the page worker module.");
...
assert.match(index, /phantom-live-20260712-227/u, "Index cache id must be bumped for the new worker module.");
