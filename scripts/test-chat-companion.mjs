...
assert.doesNotMatch(css, /\.buddy(?:\b|-)|buddyVanish/u, "Removed shell pet styling must not return through chat presence work.");

console.log("chat presence smoothness checks passed");
